...
["dart._internal", "dart:_internal", , H, {
  ...
  WhereIterator: {
    "^": "Iterator;__internal$_iterator,_f",
    _f$1: function(arg0) {
      return this._f.call$1(arg0);
    },
    moveNext$0: function() {
      for (var t1 = this.__internal$_iterator; t1.moveNext$0();)
        if (this._f$1(t1.get$current()) === true)
          return true;
      return false;
    },
    get$current: function() {
      return this.__internal$_iterator.get$current();
    }
  },
...
["dart.async", "dart:async", , P, {
  ...
  Future_Future_closure: {
    "^": "Closure:13;computation_0,result_1",
    call$0: function() {
      var e, s, exception, t1;
      try {
  ...
  Stream_Stream$fromIterable_closure: {
    "^": "Closure:13;T_0,data_1",
    call$0: function() {
      return new P._IterablePendingEvents(new H.ListIterator(this.data_1, 1, 0, null), 0);
    }
  },
  ...
  _IterablePendingEvents: {
    "^": "_PendingEvents;_iterator,_state",
    get$isEmpty: function(_) {
    ...
    handleNext$1: function(dispatch) {
      ...
      if (isDone !== true)
        dispatch._sendData$1(this._iterator._current);
      else {
        this._iterator = null;
...
["dart.convert", "dart:convert", , P, {
  ...
  _Utf8Decoder: {
    ...
    convert$3: function(codeUnits, startIndex, endIndex) {
      var t1, value, expectedUnits, extraUnits, t2, t3, t4, i, unit, t5, i0, to;
      t1 = {};
      value = this._value;
  ...
  _Utf8Decoder_convert_addSingleBytes: {
    "^": "Closure:23;box_0,this_1,codeUnits_2",
...
["dart.dom.html", "dart:html", , W, {
  ...
  BodyElement: {
    ...
    get$onMessage: function(receiver) {
      return H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(receiver, C.EventStreamProvider_message._eventType, false), [null]);
    },
    $isBodyElement: true,
    $isEventTarget: true,
    "%": "HTMLBodyElement"
  ...
  Event0: {
    ...
    "%": "AudioProcessingEvent|BeforeLoadEvent|BeforeUnloadEvent|CSSFontFaceLoadEvent|CustomEvent|DeviceMotionEvent|DeviceOrientationEvent|HashChangeEvent|IDBVersionChangeEvent|InstallEvent|InstallPhaseEvent|MIDIConnectionEvent|MediaKeyNeededEvent|MediaStreamEvent|MediaStreamTrackEvent|MutationEvent|OfflineAudioCompletionEvent|OverflowEvent|PageTransitionEvent|PopStateEvent|RTCDTMFToneChangeEvent|RTCDataChannelEvent|RTCIceCandidateEvent|SecurityPolicyViolationEvent|SpeechInputEvent|SpeechRecognitionEvent|StorageEvent|TrackEvent|TransitionEvent|WebGLContextEvent|WebKitAnimationEvent|WebKitTransitionEvent;Event|InputEvent"
  },
  EventTarget: {
    "^": "Interceptor;",
  ...
  WebSocket: {
    ...
    get$onClose: function(receiver) {
      return H.setRuntimeTypeInfo(new W._EventStream(receiver, C.EventStreamProvider_close._eventType, false), [null]);
    },
    get$onMessage: function(receiver) {
      return H.setRuntimeTypeInfo(new W._EventStream(receiver, C.EventStreamProvider_message._eventType, false), [null]);
    },
    "%": "WebSocket"
  },
  Window: {
...
["echo", "echo.dart", , D, {
  ...
  _log: [function(l) {
    var t1, t2;
    t1 = $.get$div();
    t2 = W.Element_Element$html("<code/>", null, null);
    J.set$text$x(t2, H.S(J.get$message$x(l)));
    t1.appendChild(t2);
    t1.appendChild(W.Element_Element$html("<br>", null, null));
    t1.scrollTop = C.JSNumber_methods.toInt$0(C.JSInt_methods.roundToDouble$0(C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(t1.scrollTop)) + 10000));
  }, "call$1", "_log$closure", 2, 0, 12],
  main: [function() {
    N.Logger_Logger("").set$level(C.Level_INFO_800);
    N.Logger_Logger("").get$onRecord().listen$1(D._log$closure());
    N.Logger_Logger("sockjs").info$1("Starting");
    P.print("before connect");
    Y.connect("/hello", false, null, "http://localhost:8080", null, null, null, null, null, null).then$1(new D.main_closure());
  }, "call$0", "main$closure", 0, 0, 13],
  main_closure: {
    "^": "Closure:27;",
    call$1: function(client) {
      var message, t1, headers;
      P.print("success sockjs connection");
      message = P.LinkedHashMap_LinkedHashMap$_literal(["name", "hi dart"], null, null);
      P.print(C.JsonCodec_null_null.encode$1(message));
      client.sendJson$2("/app/hello", message);
      if (client._sendingBlob)
        H.throwExpression(P.StateError$("Previous sending of BLOB not completed yet"));
      if (client._disconnected)
        H.throwExpression(P.StateError$("Disconnected"));
      t1 = client._subscribers;
      if (t1.containsKey$1("0"))
        H.throwExpression(P.StateError$("Subscription 0 can't be subscribed twice"));
      t1.$indexSet(0, "0", new Q._Subscriber("0", "/topic/greetings", C.C__ExactMatcher, 1, new D.main__closure(), C.Ack_auto));
      headers = P.LinkedHashMap_LinkedHashMap$_literal(["id", "0", "destination", "/topic/greetings"], null, null);
      t1 = client._connector;
      X.writeHeaders(t1, "SUBSCRIBE", headers, true);
      t1.writeEof$0();
    }
  },
  main__closure: {
    "^": "Closure:17;",
    call$2: function(headers, message) {
      P.print(C.JSString_methods.$add("get message", message));
    }
  }
},
1],
["events", "package:sockjs_client/src/events.dart", , Z, {
  "^": "",
  Event: {
    "^": "Object;type>"
  },
  Emitter: {
    ...
    $index: function(_, type) {
      var t1 = this.events$Emitter$_evtController;
      t1 = H.setRuntimeTypeInfo(new P._BroadcastStream(t1), [H.getTypeArgumentByIndex(t1, 0)]);
      return H.setRuntimeTypeInfo(new P._WhereStream(new Z.Emitter_operator$index_closure(type), t1), [H.getRuntimeTypeArgument(t1, "Stream", 0)]);
    },
    dispatch$1: function(evtOrType) {
      var evt, t1;
      evt = typeof evtOrType === "string" ? new Z.Event(evtOrType) : evtOrType;
      t1 = this.events$Emitter$_evtController;
      if (t1._state >= 4)
        H.throwExpression(t1._addEventError$0());
      t1._sendData$1(evt);
    }
  },
  Emitter_operator$index_closure: {
    "^": "Closure:16;type_0",
    call$1: function(e) {
      return J.get$type$x(e) === this.type_0;
    }
  }
}],
...
["logging", "package:logging/logging.dart", , N, {
  ...
  Logger: {
    ...
    }, "info$2", "call$3", "call$1", "call$2", "get$info", 2, 4, 30, 5, 5],
...
["sockjs_client", "package:sockjs_client/sockjs.dart", , L, {
  "^": "",
  XHRLocalObjectFactory: [function(method, baseUrl, payload) {
    return L.XHRLocalObject$(method, baseUrl, payload, null, null);
  }, function(method, baseUrl) {
    return L.XHRLocalObjectFactory(method, baseUrl, null);
  }, null, "call$3", "call$2", "XHRLocalObjectFactory$closure", 4, 2, 14, 5],
  XHRCorsObjectFactory: [function(method, baseUrl, payload) {
    return L.XHRCorsObject$(method, baseUrl, payload, null, null);
  }, function(method, baseUrl) {
    return L.XHRCorsObjectFactory(method, baseUrl, null);
  }, null, "call$3", "call$2", "XHRCorsObjectFactory$closure", 4, 2, 14, 5],
  InfoReceiver_InfoReceiver$forURL: function(baseUrl) {
    var url_b, t1, t2;
    url_b = J.toString$0(window.location);
    t1 = baseUrl.split("/");
    H.IterableMixinWorkaround__rangeCheck(t1, 0, 3);
    t1 = H.SubListIterable$(t1, 0, 3, null).join$1(0, "/");
    t2 = url_b.split("/");
    H.IterableMixinWorkaround__rangeCheck(t2, 0, 3);
    if (t1 === H.SubListIterable$(t2, 0, 3, null).join$1(0, "/"))
      return L.AjaxInfoReceiver$(baseUrl, L.XHRLocalObjectFactory$closure());
    switch (1) {
      case 1:
        return L.AjaxInfoReceiver$(baseUrl, L.XHRLocalObjectFactory$closure());
    }
  },
  XhrReceiverFactory: [function(recvUrl, xhrFactory) {
    return L.XhrReceiver$(recvUrl, xhrFactory);
  }, "call$2", "XhrReceiverFactory$closure", 4, 0, 15],
  createAjaxSender: function(xhrFactory) {
    return new L.createAjaxSender_closure(xhrFactory);
  },
  Protocol: {
    "^": "Object;create,enabled,roundTrips,needBody",
    create$3: function(arg0, arg1, arg2) {
      return this.create.call$3(arg0, arg1, arg2);
    }
  },
  StatusEvent: {
    "^": "Event;status>,text*,type"
  },
  AbstractXHRObject: {
    "^": "Object_Emitter;",
    get$onChunk: function() {
      return this.$index(0, "chunk");
    },
    get$onFinish: function() {
      return this.$index(0, "finish");
    },
    get$onTimeout: function(_) {
      return this.$index(0, "timeout");
    },
    _start$5$headers$noCredentials: function(method, url, payload, headers, noCredentials) {
      var exception, t1;
      try {
      ...
      try {
        J.open$2$x(this.xhr, method, url);
      } catch (exception) {
        H.unwrapException(exception);
        this.dispatch$1(new L.StatusEvent(0, "", "finish"));
        this._cleanup$0();
        return;
      }
      ...
      t1 = H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._html$_target, t1._eventType, W._wrapZone(this.get$_readyStateHandler()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)]);
      t1._tryResume$0();
      this.changeSubscription = t1;
      this.xhr.send(payload);
    },
    _start$4$noCredentials: function(method, url, payload, noCredentials) {
      return this._start$5$headers$noCredentials(method, url, payload, null, noCredentials);
    },
    _readyStateHandler$1: [function(evt) {
      var text, $status, t1, exception;
      t1 = this.xhr;
      switch (t1.readyState) {
        case 3:
          text = null;
          $status = null;
          try {
            $status = t1.status;
            text = t1.responseText;
          } catch (exception) {
            H.unwrapException(exception);
          }

          if (text != null && J.get$length$asx(text) !== 0)
            this.dispatch$1(new L.StatusEvent($status, text, "chunk"));
          break;
        case 4:
          this.dispatch$1(new L.StatusEvent(t1.status, t1.responseText, "finish"));
          this._cleanup$1(false);
          break;
      }
    }, "call$1", "get$_readyStateHandler", 2, 0, 31],
    _cleanup$1: function(abort) {
      var exception;
      if (this.xhr == null)
        return;
      this.changeSubscription.cancel$0();
      if (abort)
        try {
          this.xhr.abort();
        } catch (exception) {
    ...
    _cleanup$0: function() {
      return this._cleanup$1(false);
    },
    close$0: function(_) {
      this._cleanup$1(true);
    }
  },
  Object_Emitter: {
    "^": "Object+Emitter;"
  },
  AbstractXHRObject__start_closure: {
    "^": "Closure:17;this_0",
    call$2: function(k, v) {
      return this.this_0.xhr.setRequestHeader(k, v);
    }
  },
  XHRCorsObject: {
    "^": "AbstractXHRObject;xhr,changeSubscription,events$Emitter$_evtController",
    XHRCorsObject$5$headers$noCredentials: function(method, url, payload, headers, noCredentials) {
      P.Timer_Timer(C.Duration_0, new L.XHRCorsObject_closure(this, method, url, payload));
    },
    static: {XHRCorsObject$: function(method, url, payload, headers, noCredentials) {
        var t1 = new L.XHRCorsObject(null, null, P.StreamController_StreamController$broadcast(null, null, false, Z.Event));
        t1.XHRCorsObject$5$headers$noCredentials(method, url, payload, headers, noCredentials);
        return t1;
      }}
  },
  XHRCorsObject_closure: {
    "^": "Closure:13;this_0,method_1,url_2,payload_3",
    call$0: function() {
      return this.this_0._start$4$noCredentials(this.method_1, this.url_2, this.payload_3, false);
    }
  },
  XHRLocalObject: {
    "^": "AbstractXHRObject;xhr,changeSubscription,events$Emitter$_evtController",
    XHRLocalObject$5$headers$noCredentials: function(method, url, payload, headers, noCredentials) {
      P.Timer_Timer(C.Duration_0, new L.XHRLocalObject_closure(this, method, url, payload));
    },
    static: {XHRLocalObject$: function(method, url, payload, headers, noCredentials) {
        var t1 = new L.XHRLocalObject(null, null, P.StreamController_StreamController$broadcast(null, null, false, Z.Event));
        t1.XHRLocalObject$5$headers$noCredentials(method, url, payload, headers, noCredentials);
        return t1;
      }}
  },
  XHRLocalObject_closure: {
    "^": "Closure:13;this_0,method_1,url_2,payload_3",
    call$0: function() {
      return this.this_0._start$4$noCredentials(this.method_1, this.url_2, this.payload_3, true);
    }
  },
  CloseEvent: {
    "^": "Event;code,reason>,wasClean,lastEvent,type"
  },
  MessageEvent: {
    "^": "Event;data>,type"
  },
  Client: {
    "^": "Object_Emitter0;debug,devel,_baseUrl,server,protocol,_protocols,readyState,info<,rtt,rto,protocolsWhitelist,_ir,_transport,_transportTref,events$Emitter$_evtController",
    info$1: function(arg0) {
      return this.info.call$1(arg0);
    },
    get$onMessage: function(_) {
      return this.$index(0, "message");
    },
    get$onClose: function(_) {
      return this.$index(0, "close");
    },
    send$1: function(_, data) {
      var t1 = this.readyState;
      if (t1 === 0)
        throw H.wrapException("INVALID_STATE_ERR");
      if (t1 === 1)
        this._transport.doSend$1(C.JsonCodec_null_null.encode$1(data));
      return true;
    },
    _didClose$3: function(code, reason, force) {
      var t1, t2;
      t1 = {};
      t2 = this.readyState;
      if (t2 !== 0 && t2 !== 1 && t2 !== 2)
      ...
      t1.close_event_0 = new L.CloseEvent(code, reason, N.userSetCode(code), null, "close");
      if (!N.userSetCode(code) && this.readyState === 0 && !force) {
        if (this._tryNextProtocol$1(t1.close_event_0) === true)
          return;
        t1.close_event_0 = new L.CloseEvent(2000, "All transports failed", false, t1.close_event_0, "close");
      }
      this.readyState = 3;
      P.Timer_Timer(C.Duration_0, new L.Client__didClose_closure(t1, this));
    },
    _didClose$0: function() {
      return this._didClose$3(0, "", false);
    },
    _didClose$2: function(code, reason) {
      return this._didClose$3(code, reason, false);
    },
    _dispatchMessage$1: function(data) {
      if (this.readyState !== 1)
        return;
      this.dispatch$1(new L.MessageEvent(data, "message"));
    },
    _dispatchHeartbeat$0: function() {
      if (this.readyState !== 1)
        return;
      this.dispatch$1("heartbeat");
    },
    _didMessage$1: function(data) {
      var t1, s, payload, i, t2;
      t1 = J.getInterceptor$asx(data);
      switch (t1.$index(data, 0)) {
        case "o":
          if (this.readyState === 0) {
            t1 = this._transportTref;
            if (t1 != null) {
              t1.cancel$0();
              this._transportTref = null;
            }
            this.readyState = 1;
            this.dispatch$1("open");
          } else
            this._didClose$2(1006, "Server lost session");
          break;
        case "a":
          s = t1.substring$1(data, 1);
          payload = C.JsonCodec_null_null.decode$1(s);
          t1 = J.getInterceptor$asx(payload);
          i = 0;
          while (true) {
            t2 = t1.get$length(payload);
            if (typeof t2 !== "number")
              return H.iae(t2);
            if (!(i < t2))
              break;
            this._dispatchMessage$1(t1.$index(payload, i));
            ++i;
          }
          break;
        case "m":
          s = t1.substring$1(data, 1);
          this._dispatchMessage$1(C.JsonCodec_null_null.decode$1(s));
          break;
        case "c":
          s = t1.substring$1(data, 1);
          payload = C.JsonCodec_null_null.decode$1(s);
          t1 = J.getInterceptor$asx(payload);
          this._didClose$2(t1.$index(payload, 0), t1.$index(payload, 1));
          break;
        case "h":
          this._dispatchHeartbeat$0();
          break;
      }
    },
    _tryNextProtocol$1: function(closeEvent) {
      var t1, t2, t3, line, roundTrips, to, connid, trans_url;
      t1 = this.protocol;
      if (t1 != null) {
        t1 = "Closed transport: " + H.S(t1) + " " + J.toString$0(closeEvent);
        if (this.debug)
          P.print(t1);
        this.protocol = null;
      }
      ...
      for (t1 = this.debug; true;) {
        t2 = this._protocols;
        if (t2.length === 0)
          return false;
        t2 = C.JSArray_methods.removeAt$1(t2, 0);
        this.protocol = t2;
        if ($.get$PROTOCOLS().containsKey$1(t2))
          if ($.get$PROTOCOLS().$index(0, this.protocol).needBody)
            if (document.body != null)
              t2 = document.readyState != null && document.readyState !== "complete";
            else
              t2 = true;
          else
            t2 = false;
        ...
        if (t2) {
          ...
          t1 = document;
          t2 = C.EventStreamProvider_load._eventType;
          t3 = new W._EventStream(t1, t2, false);
          t3.$builtinTypeInfo = [null];
          t1 = new W._EventStreamSubscription(0, t1, t2, W._wrapZone(new L.Client__tryNextProtocol_closure(this)), false);
          t1.$builtinTypeInfo = [H.getTypeArgumentByIndex(t3, 0)];
          t3 = t1._html$_onData;
          if (t3 != null && t1._pauseCount <= 0)
            J.addEventListener$3$x(t1._html$_target, t2, t3, false);
          return true;
        }
        if (!$.get$PROTOCOLS().containsKey$1(this.protocol) || !$.get$PROTOCOLS().$index(0, this.protocol).enabled) {
          line = "Skipping transport: " + H.S(this.protocol);
          if (t1)
            H.printString(line);
        } else {
          roundTrips = $.get$PROTOCOLS().$index(0, this.protocol).roundTrips;
          t2 = this.rto;
          if (typeof t2 !== "number")
            return t2.$mul();
          to = t2 * roundTrips;
          this._transportTref = P.Timer_Timer(new P.Duration((to === 0 ? 5000 : to) * 1000), new L.Client__tryNextProtocol_closure0(this));
          connid = N.random_string(8, null);
          trans_url = this._baseUrl + "/" + H.S(this.server) + "/" + connid;
          line = "Opening transport: " + H.S(this.protocol) + " url:" + trans_url + " RTO:" + H.S(this.rto);
          if (t1)
            H.printString(line);
          this._transport = $.get$PROTOCOLS().$index(0, this.protocol).create$3(this, trans_url, this._baseUrl);
          return true;
        }
      }
    },
    _tryNextProtocol$0: function() {
      return this._tryNextProtocol$1(null);
    },
    Client$7$debug$devel$info$protocolsWhitelist$rtt$server: function(url, debug, devel, info, protocolsWhitelist, rtt, server) {
      var dl, t1;
      dl = window.location;
      if (!(C.JSString_methods.indexOf$1(url, "?") === -1 && C.JSString_methods.indexOf$1(url, "#") === -1))
        H.throwExpression("Only basic urls are supported in SockJS");
      if (C.JSString_methods.indexOf$1(url, "//") === 0)
        url = H.S(dl.protocol) + url;
      if (C.JSString_methods.indexOf$1(url, "/") === 0)
        url = H.S(dl.protocol) + "//" + H.S(dl.host) + url;
      t1 = H.JSSyntaxRegExp_makeNative("/[/]+$/", false, true, false);
      this._baseUrl = H.stringReplaceAllUnchecked(url, new H.JSSyntaxRegExp("/[/]+$/", t1, null, null), "");
      if (this.server == null)
        this.server = N.random_number_string(1000);
      t1 = L.InfoReceiver_InfoReceiver$forURL(this._baseUrl);
      this._ir = t1;
      t1.$index(0, "finish").listen$1(new L.Client_closure(this));
    },
    static: {Client$: function(url, debug, devel, info, protocolsWhitelist, rtt, server) {
        var t1 = new L.Client(debug, devel, null, server, null, [], 0, info, rtt, null, protocolsWhitelist, null, null, null, P.StreamController_StreamController$broadcast(null, null, false, Z.Event));
        t1.Client$7$debug$devel$info$protocolsWhitelist$rtt$server(url, debug, devel, info, protocolsWhitelist, rtt, server);
        return t1;
      }}
  },
  Object_Emitter0: {
  ...
  Client_closure: {
    ...
    call$1: function(evt) {
      ...
      t1 = this.this_0;
      t1._ir = null;
      if (evt.get$info() != null) {
        t2 = evt.get$info();
        t1.info = t2;
        t3 = t1.rtt;
        t1.rto = t3 > 100 ? 3 * t3 : t3 + 200;
        t1._protocols = N.detectProtocols(N.probeProtocols(), t1.protocolsWhitelist, t2);
        t1._didClose$0();
      } else
        t1._didClose$3(1002, "Can't connect to server", true);
    }
  },
  Client__didClose_closure: {
    "^": "Closure:13;box_0,this_1",
    call$0: function() {
      return this.this_1.dispatch$1(this.box_0.close_event_0);
    }
  },
  Client__tryNextProtocol_closure: {
    "^": "Closure:16;this_0",
    call$1: function(_) {
      return this.this_0._tryNextProtocol$0();
    }
  },
  Client__tryNextProtocol_closure0: {
    "^": "Closure:13;this_1",
    call$0: function() {
      var t1 = this.this_1;
      if (t1.readyState === 0)
        t1._didClose$2(2007, "Transport timeouted");
    }
  },
  Info: {
    "^": "Object;websocket<,origins,cookieNeeded,entropy,nullOrigin",
    Info$fromJSON$1: function(json) {
      var t1 = J.getInterceptor$asx(json);
      this.websocket = t1.$index(json, "websocket");
      this.origins = t1.$index(json, "origins");
      this.cookieNeeded = t1.$index(json, "cookie_needed");
      this.entropy = t1.$index(json, "entropy");
      this.nullOrigin = document.domain == null;
    }
  },
  InfoReceiverEvent: {
    "^": "Event;info<,rtt,type",
  ...
  AjaxInfoReceiver: {
    "^": "InfoReceiver;events$Emitter$_evtController",
    doXhr$2: function(baseUrl, xhrFactory) {
      var t1, t2, xo;
      t1 = {};
      t2 = Date.now();
      new P.DateTime(t2, false).DateTime$_now$0();
      xo = xhrFactory.call$2("GET", baseUrl + "/info");
      t1.tref_0 = P.Timer_Timer(P.Duration$(0, 0, 0, 8000, 0, 0), new L.AjaxInfoReceiver_doXhr_closure(this));
      xo.get$onFinish().listen$1(new L.AjaxInfoReceiver_doXhr_closure0(t1, this, t2));
      xo.get$onTimeout(xo).listen$1(new L.AjaxInfoReceiver_doXhr_closure1(this, xo));
    },
    AjaxInfoReceiver$2: function(baseUrl, xhrFactory) {
      P.Timer_Timer(C.Duration_0, new L.AjaxInfoReceiver_closure(this, baseUrl, xhrFactory));
    },
    static: {AjaxInfoReceiver$: function(baseUrl, xhrFactory) {
        var t1 = new L.AjaxInfoReceiver(P.StreamController_StreamController$broadcast(null, null, false, Z.Event));
        t1.AjaxInfoReceiver$2(baseUrl, xhrFactory);
        return t1;
      }}
  },
  AjaxInfoReceiver_closure: {
    "^": "Closure:13;this_0,baseUrl_1,xhrFactory_2",
    call$0: function() {
      return this.this_0.doXhr$2(this.baseUrl_1, this.xhrFactory_2);
    }
  },
  AjaxInfoReceiver_doXhr_closure: {
    "^": "Closure:13;this_1",
    call$0: function() {
      return this.this_1.dispatch$1("timeout");
    }
  },
  AjaxInfoReceiver_doXhr_closure0: {
    "^": "Closure:33;box_0,this_2,t0_3",
    call$1: function(evt) {
      var t1, t2, t3, info;
      t1 = this.box_0;
      t1.tref_0.cancel$0();
      ...
      t2 = this.this_2;
      if (t1.get$status(evt) === 200) {
        t3 = Date.now();
        new P.DateTime(t3, false).DateTime$_now$0();
        info = new L.Info(null, null, null, null, null);
        info.Info$fromJSON$1(C.JsonCodec_null_null.decode$1(t1.get$text(evt)));
        t2.dispatch$1(new L.InfoReceiverEvent(info, t3 - this.t0_3, "finish"));
      } else
        t2.dispatch$1(new L.InfoReceiverEvent(null, null, "finish"));
    }
  },
  AjaxInfoReceiver_doXhr_closure1: {
    "^": "Closure:16;this_4,xo_5",
    call$1: function(_) {
      this.xo_5._cleanup$1(true);
      this.this_4.dispatch$1(new L.InfoReceiverEvent(null, null, "finish"));
    }
  },
  Polling: {
    "^": "Object;ri,receiverFactory,recvUrl,xhrFactory,poll,pollIsClosing",
    receiverFactory$2: function(arg0, arg1) {
      return this.receiverFactory.call$2(arg0, arg1);
    },
    _scheduleRecv$0: function() {
      var t1, t2;
      t1 = {};
      t2 = this.receiverFactory$2(this.recvUrl, this.xhrFactory);
      this.poll = t2;
      t1.msg_counter_0 = 0;
      t1.messageSubscription_1 = null;
      t1.closeSubscription_2 = null;
      t1.messageSubscription_1 = J.get$onMessage$x(t2).listen$1(new L.Polling__scheduleRecv_closure(t1, this));
      t1.closeSubscription_2 = J.get$onClose$x(this.poll).listen$1(new L.Polling__scheduleRecv_closure0(t1, this));
    },
    abort$0: function(_) {
      var t1;
  ...
  Polling__scheduleRecv_closure: {
    "^": "Closure:16;box_0,this_1",
    call$1: function(e) {
      ++this.box_0.msg_counter_0;
      this.this_1.ri._didMessage$1(J.get$data$x(e));
    }
  },
  Polling__scheduleRecv_closure0: {
    "^": "Closure:16;box_0,this_2",
    call$1: function(e) {
      var t1, t2;
      t1 = this.box_0;
      t1.messageSubscription_1.cancel$0();
      t1.closeSubscription_2.cancel$0();
      t1 = this.this_2;
      t1.poll = null;
      if (!t1.pollIsClosing) {
        t2 = J.getInterceptor$x(e);
        if (J.$eq(t2.get$reason(e), "permanent"))
          t1.ri._didClose$2(1006, "Polling error (" + H.S(t2.get$reason(e)) + ")");
        else
          t1._scheduleRecv$0();
      }
    }
  ...
  XhrReceiver: {
    "^": "Receiver;xo,events$Emitter$_evtController",
    abort$0: function(_) {
      var t1 = this.xo;
      if (t1 != null) {
        J.close$0$x(t1);
        this.dispatch$1(new L.CloseEvent(null, "user", null, null, "close"));
        this.xo = null;
      }
    },
    XhrReceiver$2: function(url, xhrFactory, box_0) {
      var t1;
      box_0.buf_pos_0 = 0;
      t1 = xhrFactory.call$2("POST", url);
      this.xo = t1;
      t1.get$onChunk().listen$1(new L.XhrReceiver_closure(box_0, this));
      this.xo.get$onFinish().listen$1(new L.XhrReceiver_closure0(this));
    },
    static: {XhrReceiver$: function(url, xhrFactory) {
        var t1 = new L.XhrReceiver(null, P.StreamController_StreamController$broadcast(null, null, false, Z.Event));
        t1.XhrReceiver$2(url, xhrFactory, {});
        return t1;
      }}
  },
  XhrReceiver_closure: {
    ...
    call$1: function(e) {
      ...
      if (t1.get$status(e) !== 200)
        return;
      for (t2 = this.box_0, t3 = this.this_1; true;) {
        buf = J.substring$1$s(t1.get$text(e), t2.buf_pos_0);
        p = C.JSString_methods.indexOf$1(buf, "\n");
        if (p === -1)
          break;
        t2.buf_pos_0 = t2.buf_pos_0 + (p + 1);
        t3.dispatch$1(new L.MessageEvent(C.JSString_methods.substring$2(buf, 0, p), "message"));
      }
    }
  },
  XhrReceiver_closure0: {
    "^": "Closure:16;this_2",
    call$1: function(e) {
      var t1, t2, reason;
      t1 = this.this_2;
      t2 = J.getInterceptor$x(e);
      t1.dispatch$1(new L.StatusEvent(t2.get$status(e), t2.get$text(e), "chunk"));
      t1.xo = null;
      reason = e.status === 200 ? "network" : "permanent";
      t1.dispatch$1(new L.CloseEvent(null, reason, null, null, "close"));
    }
  },
  Receiver: {
    "^": "Object_Emitter2;",
  ...
  BufferedSender: {
    "^": "Object;",
    sender$3: function(arg0, arg1, arg2) {
      return this.sender.call$3(arg0, arg1, arg2);
    },
    doSend$1: function(message) {
      this.sendBuffer.push(message);
      if (this.sendStop == null)
        this.sendSchedule$0();
    },
    sendScheduleWait$0: function() {
      var t1 = {};
      t1.tref_0 = null;
      this.sendStop = new L.BufferedSender_sendScheduleWait_closure(t1, this);
      t1.tref_0 = P.Timer_Timer(P.Duration$(0, 0, 0, 25, 0, 0), new L.BufferedSender_sendScheduleWait_closure0(this));
    },
    sendSchedule$0: function() {
      var t1, payload;
      t1 = this.sendBuffer;
      if (t1.length !== 0) {
        payload = "[" + J.join$1$ax(t1, ",") + "]";
        this.sendStop = this.sender$3(this.transUrl, payload, new L.BufferedSender_sendSchedule_closure(this));
        this.sendBuffer = [];
      }
    }
  },
  BufferedSender_sendScheduleWait_closure: {
    "^": "Closure:13;box_0,this_1",
    call$0: function() {
      this.this_1.sendStop = null;
      this.box_0.tref_0.cancel$0();
    }
  },
  BufferedSender_sendScheduleWait_closure0: {
    "^": "Closure:13;this_2",
    call$0: function() {
      var t1 = this.this_2;
      t1.sendStop = null;
  ...
  BufferedSender_sendSchedule_closure: {
    "^": "Closure:34;this_0",
    call$2: function($status, reason) {
      var t1 = this.this_0;
      t1.sendStop = null;
      t1.sendScheduleWait$0();
    },
  ...
  createAjaxSender_closure: {
    "^": "Closure:35;xhrFactory_0",
    call$3: function(url, payload, callback) {
      this.xhrFactory_0.call$3("POST", H.S(url) + "/xhr_send", payload).get$onFinish().listen$1(new L.createAjaxSender__closure(callback));
      return new L.createAjaxSender__closure0(callback);
    }
  },
  createAjaxSender__closure: {
    "^": "Closure:16;callback_1",
    call$1: function(e) {
      this.callback_1.call$1(J.get$status$x(e));
    }
  },
  createAjaxSender__closure0: {
    "^": "Closure:16;callback_2",
    call$1: function(abort_reason) {
      this.callback_2.call$2(0, abort_reason);
    }
  },
  WebSocketTransport: {
    "^": "Object;ri,url,ws,messageSubscription,closeSubscription",
    _msgHandler$1: [function(m) {
      return this.ri._didMessage$1(J.get$data$x(m));
    }, "call$1", "get$_msgHandler", 2, 0, 16],
    _closeHandler$1: [function(m) {
      return this.ri._didMessage$1("c" + C.JsonCodec_null_null.encode$1([1006, "WebSocket connection broken"]));
    }, "call$1", "get$_closeHandler", 2, 0, 16],
    doSend$1: function(data) {
      return this.ws.send("[" + data + "]");
    },
    doCleanup$0: function() {
      if (this.ws != null) {
        this.messageSubscription.cancel$0();
        this.closeSubscription.cancel$0();
        this.ws.close();
        this.ws = null;
        this.ri = null;
      }
    },
    WebSocketTransport$2: function(ri, transUrl) {
      var url, t1;
      url = transUrl + "/websocket";
      url = C.JSString_methods.startsWith$1(url, "https") ? "wss" + C.JSString_methods.substring$1(url, 5) : "ws" + C.JSString_methods.substring$1(url, 4);
      this.url = url;
      t1 = W.WebSocket_WebSocket(url, null);
      this.ws = t1;
      t1 = H.setRuntimeTypeInfo(new W._EventStream(t1, C.EventStreamProvider_message._eventType, false), [null]);
      t1 = H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._html$_target, t1._eventType, W._wrapZone(this.get$_msgHandler()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)]);
      t1._tryResume$0();
      this.messageSubscription = t1;
      t1 = this.ws;
      t1.toString;
      t1 = H.setRuntimeTypeInfo(new W._EventStream(t1, C.EventStreamProvider_close._eventType, false), [null]);
      t1 = H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._html$_target, t1._eventType, W._wrapZone(this.get$_closeHandler()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)]);
      t1._tryResume$0();
      this.closeSubscription = t1;
    },
    static: {"^": "WebSocketTransport_roundTrips", WebSocketTransport_create: [function(ri, transUrl, baseUrl) {
        var t1 = new L.WebSocketTransport(ri, null, null, null, null);
        t1.WebSocketTransport$2(ri, transUrl);
        return t1;
      }, function(ri, transUrl) {
        return L.WebSocketTransport_create(ri, transUrl, null);
      }, null, "call$3", "call$2", "WebSocketTransport_create$closure", 4, 2, 14, 5], WebSocketTransport_enabled: function() {
        var t1, res, exception, t2;
        t1 = {};
        res = true;
        t1.ws_0 = null;
        try {
          t1.ws_0 = W.WebSocket_WebSocket("ws://echo.websocket.org", null);
        } catch (exception) {
          H.unwrapException(exception);
          res = false;
        }
          ...
          try {
            ...
            H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._html$_target, t2._eventType, W._wrapZone(new L.WebSocketTransport_enabled_closure(t1)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
          } catch (exception) {
            H.unwrapException(exception);
          }
  ...
  WebSocketTransport_enabled_closure: {
    "^": "Closure:16;box_0",
    call$1: function(e) {
      return this.box_0.ws_0.close();
    }
  },
  AjaxBasedTransport: {
    "^": "BufferedSender;",
    ...
    AjaxBasedTransport$5: function(ri, transUrl, urlSuffix, receiverFactory, xhrFactory) {
      var t1;
      this.ri = ri;
      this.transUrl = transUrl;
      t1 = L.createAjaxSender(xhrFactory);
      this.sendBuffer = [];
      this.sender = t1;
      t1 = new L.Polling(ri, receiverFactory, transUrl + urlSuffix, xhrFactory, null, false);
      t1._scheduleRecv$0();
      this.poll = t1;
    }
  },
  XhrStreamingTransport: {
    "^": "AjaxBasedTransport;ri,poll,sendBuffer,sender,sendStop,_sendStop,transUrl",
    static: {"^": "XhrStreamingTransport_roundTrips,XhrStreamingTransport_needBody", XhrStreamingTransport_create: [function(ri, transUrl, baseUrl) {
        var t1 = new L.XhrStreamingTransport(null, null, null, null, null, null, null);
        t1.AjaxBasedTransport$5(ri, transUrl, "/xhr_streaming", L.XhrReceiverFactory$closure(), L.XHRCorsObjectFactory$closure());
        return t1;
      }, function(ri, transUrl) {
        return L.XhrStreamingTransport_create(ri, transUrl, null);
      }, null, "call$3", "call$2", "XhrStreamingTransport_create$closure", 4, 2, 14, 5]}
  }
}],
["stomp", "package:stomp/stomp.dart", , Q, {
  "^": "",
  _handleHeartbeat: function(client, heartbeat) {
    var i, sx, sy, t1, t2, t3, exception;
    if (heartbeat != null)
      try {
        i = J.indexOf$1$asx(heartbeat, ",");
        sx = H.Primitives_parseInt(J.substring$2$s(heartbeat, 0, i), null, null);
        sy = H.Primitives_parseInt(J.substring$1$s(heartbeat, J.$add$ns(i, 1)), null, null);
        t1 = client.get$heartbeat();
        t2 = client.get$heartbeat()[0];
        t3 = sy;
        t1[0] = t2 === 0 || J.$eq(t3, 0) ? 0 : P.max(t2, t3);
        t1 = client.get$heartbeat();
        t2 = client.get$heartbeat()[1];
        t3 = sx;
        t1[1] = t2 === 0 || J.$eq(t3, 0) ? 0 : P.max(t2, t3);
      } catch (exception) {
        H.unwrapException(exception);
      }
  ...
  _StompClient: {
    "^": "Object;_connector,_parser,_session,_server,_onConnect,_onDisconnect,_stomp$_onError,_subscribers,_receipts,_connecting,_sendingBlob,_disconnected,heartbeat<",
    _stomp$_init$0: function() {
      this._parser = new X.FrameParser(new Q._StompClient__init_closure(this), new Q._StompClient__init_closure0(this), new X.Frame(null, null, null, null), null, 0, [], P.StringBuffer$(""));
      var t1 = this._connector;
      t1.set$onBytes(new Q._StompClient__init_closure1(this));
      t1.onString = new Q._StompClient__init_closure2(this);
      t1.onError = new Q._StompClient__init_closure3(this);
      t1.onClose = new Q._StompClient__init_closure4(this);
    },
    _handleErr$2: function(error, stackTrace) {
      var message = stackTrace != null ? H.S(error) + "\n" + H.S(stackTrace) : H.S(error);
      P.print(message);
    },
    _handleErr$1: function(error) {
      return this._handleErr$2(error, null);
    },
    sendJson$3$headers: function(destination, message, headers) {
      var t1, t2, headers0, bytes, len;
      if (this._sendingBlob)
        H.throwExpression(P.StateError$("Previous sending of BLOB not completed yet"));
      if (this._disconnected)
        H.throwExpression(P.StateError$("Disconnected"));
      t1 = this._connector;
      t2 = P.LinkedHashMap_LinkedHashMap$_literal(["destination", destination], null, null);
      headers = P.LinkedHashMap_LinkedHashMap(null, null, null, null, null);
      headers.addAll$1(0, t2);
      if (headers.$index(0, "content-type") == null) {
        headers0 = P.LinkedHashMap_LinkedHashMap(null, null, null, null, null);
        headers0.addAll$1(0, headers);
        headers = headers0;
        headers.$indexSet(0, "content-type", "application/json");
      }
      t2 = C.JsonCodec_null_null.encode$1(message);
      X.writeHeaders(t1, "SEND", headers, false);
      if (headers.$index(0, "content-length") == null) {
        if (t2.length !== 0) {
          bytes = C.Utf8Codec_false.get$encoder().convert$1(t2);
          len = bytes.length;
        } else {
          bytes = null;
          len = 0;
        }
        t1.write$1("content-length");
        t1.write$1(":");
        t1.write$1(C.JSInt_methods.toString$0(len));
        t1.writeLF$0();
      } else
        bytes = null;
      t1.writeLF$0();
    ...
    sendJson$2: function(destination, message) {
      return this.sendJson$3$headers(destination, message, null);
    },
    _stomp$_message$1: function(frame) {
      var headers, id, sub;
      headers = frame.headers;
      if (headers != null) {
        id = headers.$index(0, "subscription");
        if (id != null) {
          sub = this._subscribers.$index(0, id);
          if (sub != null && J.matches$1$x(sub, headers) === true)
            sub.onFrame$1(frame).catchError$1(new Q._StompClient__message_closure(this));
        }
      }
    }
  },
  _StompClient__init_closure: {
    "^": "Closure:36;this_0",
    call$1: function(frame) {
      var handler, t1;
      handler = $.get$_frameHandlers().$index(0, frame.command);
      t1 = this.this_0;
      if (handler != null)
        handler.call$2(t1, frame);
      else
        t1._handleErr$1("Unknown command: " + H.S(frame.command));
    }
  },
  _StompClient__init_closure0: {
    "^": "Closure:17;this_1",
    call$2: function(error, stackTrace) {
      this.this_1._handleErr$2(error, stackTrace);
    }
  },
  _StompClient__init_closure1: {
    "^": "Closure:37;this_2",
    call$1: function(data) {
      this.this_2._parser.addBytes$1(data);
    }
  },
  _StompClient__init_closure2: {
    "^": "Closure:0;this_3",
    call$1: function(data) {
      this.this_3._parser.addString$1(data);
    }
  },
  _StompClient__init_closure3: {
    "^": "Closure:17;this_4",
    call$2: function(error, stackTrace) {
      this.this_4._handleErr$2(error, stackTrace);
    }
  },
  _StompClient__init_closure4: {
    "^": "Closure:13;this_5",
    call$0: function() {
      var t1 = this.this_5;
      t1._disconnected = true;
      t1._subscribers.clear$0(0);
      t1._receipts.clear$0(0);
    }
  },
  _StompClient__message_closure: {
    "^": "Closure:17;this_0",
    call$2: function(error, stackTrace) {
      this.this_0._handleErr$2(error, stackTrace);
    }
  },
  closure: {
    "^": "Closure:38;",
    call$2: function(client, frame) {
      var headers, connecting, t1;
      headers = frame.headers;
      if (headers != null) {
        client._session = headers.$index(0, "session");
        client._server = headers.$index(0, "server");
        Q._handleHeartbeat(client, headers.$index(0, "heart-beat"));
      }
      connecting = client._connecting;
      if (connecting != null) {
        client._connecting = null;
        t1 = connecting.future;
        if (t1._state !== 0)
          H.throwExpression(P.StateError$("Future already completed"));
        t1._asyncComplete$1(client);
      }
    }
  },
  closure0: {
    "^": "Closure:38;",
    call$2: function(client, frame) {
      var connecting, headers, message, detail, t1;
      connecting = client._connecting;
      if (connecting != null) {
        client._connecting = null;
        connecting.completeError$1(frame.get$message(frame));
      } else {
        headers = frame.headers;
        message = headers != null ? headers.$index(0, "message") : null;
        detail = frame.get$message(frame);
        if (message != null)
          t1 = detail != null ? H.S(message) + "\n" + detail : message;
        else
          t1 = detail;
        P.print(t1);
      }
  ...
  closure1: {
    "^": "Closure:38;",
    call$2: function(client, frame) {
      client._stomp$_message$1(frame);
    }
  },
  closure2: {
    "^": "Closure:38;",
    call$2: function(client, frame) {
      var headers, id, callback;
      headers = frame.headers;
      if (headers != null) {
        id = headers.$index(0, "receipt-id");
        callback = client._receipts.$index(0, id);
        if (callback != null)
          callback.call$1(id);
      }
    }
  ...
  _Subscriber: {
    "^": "Object;id,destination,matcher,type>,onMessage>,ack",
    onMessage$2: function($receiver, arg0, arg1) {
      return this.onMessage.call$2(arg0, arg1);
    },
    matches$1: function(_, headers) {
      return this.destination === headers.$index(0, "destination");
    },
    onFrame$1: function(frame) {
      return P.Future_Future(new Q._Subscriber_onFrame_closure(this, frame), null);
    }
  },
  _Subscriber_onFrame_closure: {
    "^": "Closure:13;this_0,frame_1",
    call$0: function() {
      var t1, t2;
      t1 = this.this_0;
      switch (t1.type) {
        case 0:
          t2 = this.frame_1;
          t1.onMessage$2(0, t2.headers, t2.get$messageBytes());
          break;
        case 1:
          t2 = this.frame_1;
          t1.onMessage$2(0, t2.headers, t2.get$message(t2));
          break;
        case 2:
          t2 = this.frame_1;
          t1.onMessage$2(0, t2.headers, C.JsonCodec_null_null.decode$1(t2.get$message(t2)));
          break;
        case 3:
          t2 = this.frame_1;
          t1.onMessage$2(0, t2.headers, P.Stream_Stream$fromIterable([t2.get$messageBytes()], null));
          break;
      }
    }
  },
...
["stomp_impl_plugin", "package:stomp/impl/plugin.dart", , Z, {
  "^": "",
  StompConnector: {
    "^": "Object;onBytes?,onClose>",
    onString$1: function(arg0) {
      return this.onString.call$1(arg0);
    },
  ...
  StringStompConnector: {
    "^": "StompConnector;",
    write$2: function(string, bytes) {
      if (string != null)
        this._write$1(string);
      else if (bytes != null && !J.get$isEmpty$asx(bytes))
        this._write$1(C.Utf8Codec_false.decode$1(bytes));
    },
    write$1: function(string) {
      return this.write$2(string, null);
    },
    _write$1: function(data) {
      var t1, len, t2, t3, i, j, data0;
      t1 = J.getInterceptor$asx(data);
      ...
      if (typeof len !== "number")
        return H.iae(len);
      if (t3.length + len >= 16384) {
        this._flush$0();
        for (i = 0; true; i = j) {
          j = i + 16384;
          if (j > len) {
            data0 = t1.substring$1(data, i);
            data = data0;
            break;
          }
          this.writeString_$1(t1.substring$2(data, i, j));
        }
      }
      t2.write$1(data);
    },
    _flush$0: function() {
      ...
      if (t2.length !== 0) {
        t1._contents = "";
        this.writeString_$1(t2);
      }
    },
    _flushAsync$0: function() {
      P.Future_Future(new Z.StringStompConnector__flushAsync_closure(this), null);
    },
    writeEof$0: function() {
      this._write$1("\u0000");
      this._flushAsync$0();
  ...
  StringStompConnector__flushAsync_closure: {
    "^": "Closure:13;this_0",
    call$0: function() {
      this.this_0._flush$0();
    }
  }
}],
["stomp_impl_util", "package:stomp/impl/util.dart", , X, {
  "^": "",
  _unescape: function(value) {
    var len, buf, pre, i, j, esc, t1;
    for (len = value.length, buf = null, pre = 0, i = 0; i < len; ++i)
      if (value[i] === "\\") {
        j = i + 1;
        if (j < len) {
          switch (value[j]) {
          ...
          if (esc != null) {
            ...
            t1 = C.JSString_methods.substring$2(value, pre, i);
            buf.toString;
            t1 = buf._contents + t1;
            buf._contents = t1;
            buf._contents = t1 + esc;
            pre = j + 1;
            i = j;
          }
        }
    ...
    if (buf != null) {
      t1 = C.JSString_methods.substring$1(value, pre);
      buf._contents += t1;
      t1 = buf.toString$0(0);
    } else
      t1 = value;
  ...
  writeHeaders: function(connector, command, headers, endOfHeaders) {
    var t1, t2, $name;
    connector.write$1(command);
    connector.writeLF$0();
    if (headers != null)
      for (t1 = headers.get$keys()._map, t2 = new P.LinkedHashMapKeyIterator(t1, t1._modifications, null, null), t2._cell = t1._first; t2.moveNext$0();) {
        $name = t2._collection$_current;
        connector.write$1(X._escape($name));
        connector.write$1(":");
        connector.write$1(X._escape(headers.$index(0, $name)));
        connector.writeLF$0();
      }
    if (endOfHeaders)
      connector.writeLF$0();
  ...
  _escape: function(value) {
    ...
    for (; i < len; ++i) {
      ...
      if (esc != null) {
        ...
        t2 = t1.substring$2(value, pre, i);
        buf.toString;
        t2 = buf._contents + t2;
        buf._contents = t2;
        t2 += "\\";
        buf._contents = t2;
        buf._contents = t2 + esc;
        pre = i + 1;
      }
    }
    if (buf != null) {
      t1 = t1.substring$1(value, pre);
      buf._contents += t1;
      t1 = buf.toString$0(0);
    } else
      t1 = value;
  ...
  Frame: {
    "^": "Object;command,headers,string,bytes",
    get$message: function(_) {
      ...
      if (t1 != null)
        ...
        t1 = this.bytes;
        t1 = t1 != null ? C.Utf8Codec_false.decode$1(t1) : "";
      }
      return t1;
    },
    get$messageBytes: function() {
      var t1 = this.bytes;
      if (t1 != null)
        ;
      else {
        t1 = this.string;
        t1 = t1 != null ? C.Utf8Codec_false.get$encoder().convert$1(t1) : [];
      }
      return t1;
    },
    get$contentLength: function() {
      var val, t1, exception;
      t1 = this.headers;
      if (t1 != null) {
        val = t1.$index(0, "content-length");
        if (val != null)
          try {
            t1 = H.Primitives_parseInt(val, null, null);
            return t1;
          } catch (exception) {
            H.unwrapException(exception);
          }
  ...
  FrameParser: {
    "^": "Object;_onFrame,_stomp_impl_util$_onError,_frame,_bodylen,_stomp_impl_util$_state,_bytebuf,_strbuf",
    _onFrame$1: function(arg0) {
      return this._onFrame.call$1(arg0);
    },
    _stomp_impl_util$_onError$2: function(arg0, arg1) {
      return this._stomp_impl_util$_onError.call$2(arg0, arg1);
    },
    addBytes$1: function(bytes) {
      var ex, st, exception, t1;
      if (bytes != null)
        try {
          if (this._stomp_impl_util$_state === 2)
            this._addBodyFrag$2(null, bytes);
          else
            this._addHeaderFrag$1(C.Utf8Codec_false.decode$1(bytes));
        } catch (exception) {
          t1 = H.unwrapException(exception);
          ex = t1;
          st = new H._StackTrace(exception, null);
          this._errorFound$2(ex, st);
        }

    },
    addString$1: function(string) {
      var ex, st, exception, t1;
      if (string != null)
        try {
          if (this._stomp_impl_util$_state === 2)
            this._addBodyFrag$1(string);
          else
            this._addHeaderFrag$1(string);
        } catch (exception) {
          t1 = H.unwrapException(exception);
          ex = t1;
          st = new H._StackTrace(exception, null);
    ...
    _addHeaderFrag$1: function(string) {
      var i, t1, t2, pre, line, k, $name, value, unescapedName, i0;
      i = J.indexOf$1$asx(string, "\n");
      if (i < 0) {
        this._strbuf.write$1(string);
        return;
      }
      t1 = this._strbuf;
      t2 = t1._contents.length;
      if (t2 !== 0) {
        i += t2;
        t1.write$1(string);
        string = t1._contents;
        this._strbuf._contents = "";
      }
      for (t1 = J.getInterceptor$asx(string), pre = 0; true; pre = i, i = i0) {
        line = t1.substring$2(string, pre, i > pre && J.$eq(t1.$index(string, i - 1), "\r") ? i - 1 : i);
        ++i;
        if (this._stomp_impl_util$_state === 0) {
          if (line.length !== 0) {
            this._frame.command = line;
            this._stomp_impl_util$_state = 1;
          }
        } else if (line.length === 0) {
          this._stomp_impl_util$_state = 2;
          this._bodylen = this._frame.get$contentLength();
          if (i < string.length)
            this._addBodyFrag$1(C.JSString_methods.substring$1(string, i));
          return;
        } else {
          k = C.JSString_methods.indexOf$1(line, ":");
          t2 = k >= 0;
          $name = t2 ? C.JSString_methods.substring$2(line, 0, k) : line;
          value = t2 ? C.JSString_methods.substring$1(line, k + 1) : "";
          t2 = this._frame;
          if (t2.headers == null)
            t2.headers = P.LinkedHashMap_LinkedHashMap(null, null, null, null, null);
          unescapedName = X._unescape($name);
          if (!this._frame.headers.containsKey$1(unescapedName))
            this._frame.headers.$indexSet(0, unescapedName, X._unescape(value));
        }
        i0 = C.JSString_methods.indexOf$2(string, "\n", i);
        if (i0 < 0) {
          if (i < string.length) {
            t1 = this._strbuf;
            t2 = C.JSString_methods.substring$1(string, i);
            t1._contents += t2;
          }
          return;
        }
    ...
    _addBodyFrag$2: function(string, bytes) {
      var t1, len, i, allowMalformed, t2, s, t3;
      if (this._bodylen != null && bytes == null)
        bytes = C.Utf8Codec_false.get$encoder().convert$1(string);
      if (bytes != null) {
        t1 = this._strbuf._contents;
        if (t1.length !== 0) {
          this._bytebuf = C.Utf8Codec_false.get$encoder().convert$1(t1);
          this._strbuf._contents = "";
        }
        t1 = this._bodylen;
        if (t1 != null) {
          if (J.$le$n(J.$add$ns(t1, 1), this._bytebuf.length + bytes.length)) {
            this._frameBytes$2(bytes, J.$sub$n(this._bodylen, this._bytebuf.length));
            return;
          }
        } else
          for (len = bytes.length, i = 0; i < len; ++i) {
            if (i >= bytes.length)
              return H.ioore(bytes, i);
            if (J.$eq(bytes[i], 0)) {
              this._frameBytes$2(bytes, i);
              return;
            }
          }
        J.addAll$1$ax(this._bytebuf, bytes);
        return;
      }
      if (!J.get$isEmpty$asx(this._bytebuf)) {
        t1 = this._bytebuf;
        allowMalformed = C.Utf8Codec_false._allowMalformed;
        t1 = new P.Utf8Decoder(allowMalformed).convert$1(t1);
      ...
      i = 0;
      for (; i < len; ++i)
        if (J.$eq(t1.$index(string, i), "\u0000")) {
          s = t1.substring$2(string, 0, i);
          t2 = this._frame;
          t1 = this._strbuf;
          t3 = t1._contents;
          t2.string = t3.length === 0 ? s : t3 + s;
          t1._contents = "";
          ++i;
          if (i < len) {
            t2 = C.JSString_methods.substring$1(string, i);
      ...
      t1 = this._strbuf;
      t1._contents += typeof string === "string" ? string : H.S(string);
    },
    _addBodyFrag$1: function(string) {
      return this._addBodyFrag$2(string, null);
    },
    _frameBytes$2: function(bytes, len) {
      var curr, t1, t2;
      curr = J.getInterceptor$ax(bytes).sublist$2(bytes, 0, len);
      t1 = J.get$isEmpty$asx(this._bytebuf);
      t2 = this._frame;
      if (t1)
        t2.bytes = curr;
      else {
        t1 = this._bytebuf;
        t2.bytes = t1;
        J.addAll$1$ax(t1, curr);
      }
      if (len >>> 0 !== len || len >= bytes.length)
        return H.ioore(bytes, len);
      if (J.$eq(bytes[len], 0))
        ++len;
      this._bytebuf = len < bytes.length ? C.JSArray_methods.sublist$1(bytes, len) : [];
      this._frameFound$0();
    },
    _frameFound$0: function() {
      var frame, bytes, t1, t2;
      frame = this._frame;
      this._frame = new X.Frame(null, null, null, null);
      this._bodylen = null;
      this._stomp_impl_util$_state = 0;
      this._onFrame$1(frame);
      if (!J.get$isEmpty$asx(this._bytebuf)) {
        bytes = this._bytebuf;
        this._bytebuf = [];
        this.addBytes$1(bytes);
      }
      t1 = this._strbuf;
      t2 = t1._contents;
      if (t2.length !== 0) {
    ...
    _errorFound$2: function(error, stackTrace) {
      this._strbuf._contents = "";
      if (!J.get$isEmpty$asx(this._bytebuf))
        this._bytebuf = [];
      this._frame = new X.Frame(null, null, null, null);
      this._bodylen = null;
      this._stomp_impl_util$_onError$2(error, stackTrace);
    }
  }
}],
["stomp_sockjs", "stomp_sockjs.dart", , Y, {
  "^": "",
  connect: function(url, debugFlag, heartbeat, host, login, onConnectionError, onDisconnect, onError, passcode, protocolsWhiteList) {
    var connector = new Y._SockDartConnector(L.Client$(url, debugFlag, true, null, protocolsWhiteList, 0, null), H.setRuntimeTypeInfo(new P._AsyncCompleter(P._Future$(null)), [null]), P.StringBuffer$(""), null, null, null, null);
    connector._init$0();
    return connector._starting.future.then$1(new Y.connect_closure(host, login, passcode, heartbeat, onDisconnect, onError, onConnectionError));
  },
  connect_closure: {
    "^": "Closure:16;host_0,login_1,passcode_2,heartbeat_3,onDisconnect_4,onError_5,onConnectionError_6",
    call$1: function(connector) {
      var t1, client, headers;
      P.print("Got SockJS/SockDart connection");
      if (connector == null)
        H.throwExpression(P.ArgumentError$("Required: connector. Use stomp_vm's connect() instead."));
      t1 = Array(2);
      client = new Q._StompClient(connector, null, null, null, null, this.onDisconnect_4, this.onError_5, P.HashMap_HashMap(null, null, null, null, null), P.HashMap_HashMap(null, null, null, null, null), null, false, false, t1);
      client._stomp$_init$0();
      client._connecting = H.setRuntimeTypeInfo(new P._AsyncCompleter(P._Future$(null)), [null]);
      headers = P.LinkedHashMap_LinkedHashMap(null, null, null, null, null);
      headers.$indexSet(0, "accept-version", "1.2");
      headers.$indexSet(0, "host", this.host_0);
      t1[1] = 0;
      t1[0] = 0;
      X.writeHeaders(connector, "STOMP", headers, true);
      connector.writeEof$0();
      return client._connecting.future.catchError$1(new Y.connect__closure(this.onConnectionError_6));
    }
  },
  connect__closure: {
    "^": "Closure:16;onConnectionError_7",
    call$1: function(e) {
      P.print(e);
      this.onConnectionError_7.call$2(e, e);
    }
  },
  _SockDartConnector: {
    "^": "StringStompConnector;_socket,_starting,_buf,onBytes,onString,onError,onClose",
    _init$0: function() {
      var t1 = this._socket;
      t1.$index(0, "open").listen$1(new Y._SockDartConnector__init_closure(this));
      t1.$index(0, "message").listen$3$onDone$onError(new Y._SockDartConnector__init_closure0(this), new Y._SockDartConnector__init_closure1(this), new Y._SockDartConnector__init_closure2(this));
      t1.$index(0, "close").listen$1(new Y._SockDartConnector__init_closure3(this));
    },
    writeString_$1: function(string) {
      var t1, t2;
      t1 = this._socket;
      t2 = t1.readyState;
      if (t2 === 0)
        H.throwExpression("INVALID_STATE_ERR");
      if (t2 === 1)
        t1._transport.doSend$1(C.JsonCodec_null_null.encode$1(string));
    },
    close$0: function(_) {
      P.print("Not sure what to do with close here...close...");
      return P._Future$immediate(null, null);
    }
  },
  _SockDartConnector__init_closure: {
    "^": "Closure:16;this_0",
    call$1: function(_) {
      var t1, t2;
      P.print("here is onOpen");
      t1 = this.this_0;
      t2 = t1._starting.future;
      if (t2._state !== 0)
        H.throwExpression(P.StateError$("Future already completed"));
  ...
  _SockDartConnector__init_closure0: {
    "^": "Closure:16;this_1",
    call$1: function($event) {
      var data, sdata;
      P.print("here is onMessage");
      data = J.get$data$x($event);
      if (data != null) {
        sdata = J.toString$0(data);
        if (J.get$isEmpty$asx(sdata) !== true)
          this.this_1.onString$1(sdata);
      }
    }
  },
  _SockDartConnector__init_closure2: {
    "^": "Closure:17;this_2",
    call$2: function(error, stackTrace) {
      this.this_2.onError$2(0, error, stackTrace);
    }
  },
  _SockDartConnector__init_closure1: {
    "^": "Closure:13;this_3",
    call$0: function() {
      var t1 = this.this_3;
      if (t1.onClose != null)
  ...
  _SockDartConnector__init_closure3: {
    "^": "Closure:16;this_4",
    call$1: function($event) {
      var t1 = this.this_4;
      if (t1.onClose != null)
...
["utils", "package:sockjs_client/src/utils.dart", , N, {
  "^": "",
  random_string: function($length, max) {
    var ret, i, r;
    ret = [];
    for (i = 0; i < $length; ++i) {
      r = C.C__JSRandom.nextInt$1(37);
      ret.push(C.JSString_methods.substring$2("abcdefghijklmnopqrstuvwxyz0123456789_", r, r + 1));
    }
    return C.JSArray_methods.join$1(ret, "");
  },
  random_number_string: function(max) {
    var t, l, t1, i, p, s;
    t = ("" + (max - 1)).length;
    l = [];
    for (t1 = t + 1, i = 0; i < t1; ++i)
      l.push("0");
    p = C.JSArray_methods.join$1(l, "");
    s = p + C.C__JSRandom.nextInt$1(max);
    return C.JSString_methods.substring$1(s, s.length - t);
  },
  userSetCode: function(code) {
    var t1 = J.getInterceptor(code);
    if (!t1.$eq(code, 1000))
      t1 = t1.$ge(code, 3000) && t1.$le(code, 4999);
    else
      t1 = true;
    return t1;
  },
  probeProtocols: function() {
    var probed = P.LinkedHashMap_LinkedHashMap$_empty(null, null);
    H.IterableMixinWorkaround_forEach(C.List_mlV, new N.probeProtocols_closure(probed));
    return probed;
  },
  detectProtocols: function(probed, protocols_whitelist, info) {
    var t1, pe, protocols;
    t1 = {};
    pe = P.LinkedHashMap_LinkedHashMap$_empty(null, null);
    protocols = [];
    if (protocols_whitelist == null)
      protocols_whitelist = C.List_mlV;
    protocols_whitelist.toString;
    H.IterableMixinWorkaround_forEach(protocols_whitelist, new N.detectProtocols_closure(probed, pe));
    t1.maybe_push_0 = null;
    t1.maybe_push_0 = new N.detectProtocols_closure0(t1, pe, protocols);
    if (info.get$websocket() === true)
      t1.maybe_push_0.call$1(["websocket"]);
    if (pe.$index(0, "xhr-streaming") != null && !info.nullOrigin)
      protocols.push("xhr-streaming");
    else if (pe.$index(0, "xdr-streaming") != null && info.cookieNeeded !== true && !info.nullOrigin)
      protocols.push("xdr-streaming");
    else
      t1.maybe_push_0.call$1(["iframe-eventsource", "iframe-htmlfile"]);
    if (pe.$index(0, "xhr-polling") != null && !info.nullOrigin)
      protocols.push("xhr-polling");
    else if (pe.$index(0, "xdr-polling") != null && info.cookieNeeded !== true && !info.nullOrigin)
      protocols.push("xdr-polling");
    else
      t1.maybe_push_0.call$1(["iframe-xhr-polling", "jsonp-polling"]);
    return protocols;
  },
  probeProtocols_closure: {
    "^": "Closure:16;probed_0",
    call$1: function(protocol) {
      var t1 = $.get$PROTOCOLS().containsKey$1(protocol) && $.get$PROTOCOLS().$index(0, protocol).enabled;
      this.probed_0.$indexSet(0, protocol, t1);
    }
  },
  detectProtocols_closure: {
    "^": "Closure:16;probed_1,pe_2",
    call$1: function(protocol) {
      var t1 = this.probed_1.$index(0, protocol);
      this.pe_2.$indexSet(0, protocol, t1);
      return t1;
    }
  },
  detectProtocols_closure0: {
    "^": "Closure:39;box_0,pe_3,protocols_4",
    call$1: function(protos) {
      var proto = C.JSArray_methods.removeAt$1(protos, 0);
      if (this.pe_3.$index(0, proto) != null)
        this.protocols_4.push(proto);
      else if (protos.length !== 0)
        this.box_0.maybe_push_0.call$1(protos);
    }
  }
}],
]);
...
W.CloseEvent0.$isEvent0 = true;
W.CloseEvent0.$isObject = true;
W.MessageEvent0.$isEvent0 = true;
...
Q.StompClient.$isStompClient = true;
Q.StompClient.$isObject = true;
P.Symbol.$isSymbol = true;
P.Symbol.$isObject = true;
P.StackTrace.$isStackTrace = true;
P.StackTrace.$isObject = true;
L.InfoReceiverEvent.$isInfoReceiverEvent = true;
L.InfoReceiverEvent.$isObject = true;
...
L.StatusEvent.$isStatusEvent = true;
L.StatusEvent.$isObject = true;
...
Q._StompClient.$is_StompClient = true;
Q._StompClient.$isStompClient = true;
Q._StompClient.$isObject = true;
L.AbstractXHRObject.$isAbstractXHRObject = true;
L.AbstractXHRObject.$isObject = true;
...
C.Ack_auto = new Q.Ack("auto");
C.C_DynamicRuntimeType = new H.DynamicRuntimeType();
C.C__DelayedDone = new P._DelayedDone();
C.C__ExactMatcher = new Q._ExactMatcher();
...
C.List_mlV = Isolate.makeConstantList(["websocket", "xdr-streaming", "xhr-streaming", "iframe-eventsource", "iframe-htmlfile", "xdr-polling", "xhr-polling", "iframe-xhr-polling", "jsonp-polling"]);
...
Isolate.$lazy($, "div", "div", "get$div", function() {
  return document.querySelector("#first div");
});
...
Isolate.$lazy($, "PROTOCOLS", "PROTOCOLS", "get$PROTOCOLS", function() {
  return P.LinkedHashMap_LinkedHashMap$_literal(["websocket", new L.Protocol(L.WebSocketTransport_create$closure(), L.WebSocketTransport_enabled(), 2, false), "xhr-streaming", new L.Protocol(L.XhrStreamingTransport_create$closure(), true, 2, false)], null, null);
});
Isolate.$lazy($, "_frameHandlers", "_frameHandlers", "get$_frameHandlers", function() {
  return P.LinkedHashMap_LinkedHashMap$_literal(["CONNECTED", new Q.closure(), "ERROR", new Q.closure0(), "MESSAGE", new Q.closure1(), "RECEIPT", new Q.closure2()], null, null);
});
// Native classes
...
{func: "dynamic__String_AjaxObjectFactory", args: [P.String, {func: "AbstractXHRObject__String_String__dynamic", ret: L.AbstractXHRObject, args: [P.String, P.String], opt: [null]}]},
...
{func: "dynamic__StompClient", args: [Q.StompClient]},
...
{func: "dynamic__InfoReceiverEvent", args: [L.InfoReceiverEvent]},
{func: "dynamic__StatusEvent", args: [L.StatusEvent]},
{func: "dynamic___dynamic_dynamic", opt: [null, null]},
{func: "dynamic__dynamic_dynamic_dynamic___dynamic_dynamic", args: [null, null, {func: "dynamic___dynamic_dynamic", opt: [null, null]}]},
{func: "dynamic__Frame", args: [X.Frame]},
{func: "dynamic__List", args: [[P.List, P.$int]]},
{func: "dynamic___StompClient_Frame", args: [Q._StompClient, X.Frame]},
...
function dart_precompiled($collectedClasses) {
  ...
  function CloseEvent0() {
  }
  CloseEvent0.builtin$cls = "CloseEvent0";
  if (!"name" in CloseEvent0)
    CloseEvent0.name = "CloseEvent0";
  $desc = $collectedClasses.CloseEvent0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  CloseEvent0.prototype = $desc;
  CloseEvent0.prototype.get$reason = function(receiver) {
    return receiver.reason;
  };
  function Comment() {
  }
  ...
  function WhereIterator(__internal$_iterator, _f) {
    this.__internal$_iterator = __internal$_iterator;
    this._f = _f;
  }
  ...
  function _IterablePendingEvents(_iterator, _state) {
  ...
  function Emitter_operator$index_closure(type_0) {
    this.type_0 = type_0;
  }
  Emitter_operator$index_closure.builtin$cls = "Emitter_operator$index_closure";
  if (!"name" in Emitter_operator$index_closure)
    Emitter_operator$index_closure.name = "Emitter_operator$index_closure";
  $desc = $collectedClasses.Emitter_operator$index_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Emitter_operator$index_closure.prototype = $desc;
  ...
  function Protocol(create, enabled, roundTrips, needBody) {
    this.create = create;
  ...
  function StatusEvent(status, text, type) {
    this.status = status;
    this.text = text;
    this.type = type;
  }
  StatusEvent.builtin$cls = "StatusEvent";
  if (!"name" in StatusEvent)
    StatusEvent.name = "StatusEvent";
  $desc = $collectedClasses.StatusEvent;
  if ($desc instanceof Array)
    $desc = $desc[1];
  StatusEvent.prototype = $desc;
  StatusEvent.prototype.get$status = function(receiver) {
    return this.status;
  };
  StatusEvent.prototype.get$text = function(receiver) {
    return this.text;
  };
  StatusEvent.prototype.set$text = function(receiver, v) {
    return this.text = v;
  };
  function AbstractXHRObject() {
  }
  AbstractXHRObject.builtin$cls = "AbstractXHRObject";
  if (!"name" in AbstractXHRObject)
    AbstractXHRObject.name = "AbstractXHRObject";
  $desc = $collectedClasses.AbstractXHRObject;
  if ($desc instanceof Array)
    $desc = $desc[1];
  AbstractXHRObject.prototype = $desc;
  function Object_Emitter() {
  }
  Object_Emitter.builtin$cls = "Object_Emitter";
  if (!"name" in Object_Emitter)
    Object_Emitter.name = "Object_Emitter";
  $desc = $collectedClasses.Object_Emitter;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Object_Emitter.prototype = $desc;
  function AbstractXHRObject__start_closure(this_0) {
    this.this_0 = this_0;
  }
  AbstractXHRObject__start_closure.builtin$cls = "AbstractXHRObject__start_closure";
  if (!"name" in AbstractXHRObject__start_closure)
    AbstractXHRObject__start_closure.name = "AbstractXHRObject__start_closure";
  $desc = $collectedClasses.AbstractXHRObject__start_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  AbstractXHRObject__start_closure.prototype = $desc;
  function XHRCorsObject(xhr, changeSubscription, events$Emitter$_evtController) {
    this.xhr = xhr;
    this.changeSubscription = changeSubscription;
    this.events$Emitter$_evtController = events$Emitter$_evtController;
  }
  XHRCorsObject.builtin$cls = "XHRCorsObject";
  if (!"name" in XHRCorsObject)
    XHRCorsObject.name = "XHRCorsObject";
  $desc = $collectedClasses.XHRCorsObject;
  if ($desc instanceof Array)
    $desc = $desc[1];
  XHRCorsObject.prototype = $desc;
  function XHRCorsObject_closure(this_0, method_1, url_2, payload_3) {
    this.this_0 = this_0;
    this.method_1 = method_1;
    this.url_2 = url_2;
    this.payload_3 = payload_3;
  }
  XHRCorsObject_closure.builtin$cls = "XHRCorsObject_closure";
  if (!"name" in XHRCorsObject_closure)
    XHRCorsObject_closure.name = "XHRCorsObject_closure";
  $desc = $collectedClasses.XHRCorsObject_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  XHRCorsObject_closure.prototype = $desc;
  function XHRLocalObject(xhr, changeSubscription, events$Emitter$_evtController) {
    this.xhr = xhr;
    this.changeSubscription = changeSubscription;
    this.events$Emitter$_evtController = events$Emitter$_evtController;
  }
  XHRLocalObject.builtin$cls = "XHRLocalObject";
  if (!"name" in XHRLocalObject)
    XHRLocalObject.name = "XHRLocalObject";
  $desc = $collectedClasses.XHRLocalObject;
  if ($desc instanceof Array)
    $desc = $desc[1];
  XHRLocalObject.prototype = $desc;
  function XHRLocalObject_closure(this_0, method_1, url_2, payload_3) {
    this.this_0 = this_0;
    this.method_1 = method_1;
    this.url_2 = url_2;
    this.payload_3 = payload_3;
  }
  XHRLocalObject_closure.builtin$cls = "XHRLocalObject_closure";
  if (!"name" in XHRLocalObject_closure)
    XHRLocalObject_closure.name = "XHRLocalObject_closure";
  $desc = $collectedClasses.XHRLocalObject_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  XHRLocalObject_closure.prototype = $desc;
  function CloseEvent(code, reason, wasClean, lastEvent, type) {
    this.code = code;
    this.reason = reason;
  ...
  function MessageEvent(data, type) {
    this.data = data;
    this.type = type;
  }
  ...
  function Client(debug, devel, _baseUrl, server, protocol, _protocols, readyState, info, rtt, rto, protocolsWhitelist, _ir, _transport, _transportTref, events$Emitter$_evtController) {
    this.debug = debug;
    this.devel = devel;
    ...
    this._transportTref = _transportTref;
    this.events$Emitter$_evtController = events$Emitter$_evtController;
  }
  ...
  Client.prototype.get$info = function() {
    return this.info;
  };
  function Object_Emitter0() {
  }
  Object_Emitter0.builtin$cls = "Object_Emitter0";
  if (!"name" in Object_Emitter0)
    Object_Emitter0.name = "Object_Emitter0";
  $desc = $collectedClasses.Object_Emitter0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Object_Emitter0.prototype = $desc;
  ...
  function Client__didClose_closure(box_0, this_1) {
    this.box_0 = box_0;
    this.this_1 = this_1;
  }
  Client__didClose_closure.builtin$cls = "Client__didClose_closure";
  if (!"name" in Client__didClose_closure)
    Client__didClose_closure.name = "Client__didClose_closure";
  $desc = $collectedClasses.Client__didClose_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Client__didClose_closure.prototype = $desc;
  function Client__tryNextProtocol_closure(this_0) {
    this.this_0 = this_0;
  }
  Client__tryNextProtocol_closure.builtin$cls = "Client__tryNextProtocol_closure";
  if (!"name" in Client__tryNextProtocol_closure)
    Client__tryNextProtocol_closure.name = "Client__tryNextProtocol_closure";
  $desc = $collectedClasses.Client__tryNextProtocol_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Client__tryNextProtocol_closure.prototype = $desc;
  function Client__tryNextProtocol_closure0(this_1) {
    this.this_1 = this_1;
  }
  Client__tryNextProtocol_closure0.builtin$cls = "Client__tryNextProtocol_closure0";
  if (!"name" in Client__tryNextProtocol_closure0)
    Client__tryNextProtocol_closure0.name = "Client__tryNextProtocol_closure0";
  $desc = $collectedClasses.Client__tryNextProtocol_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Client__tryNextProtocol_closure0.prototype = $desc;
  function Info(websocket, origins, cookieNeeded, entropy, nullOrigin) {
  ...
  Info.builtin$cls = "Info";
  if (!"name" in Info)
    Info.name = "Info";
  $desc = $collectedClasses.Info;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Info.prototype = $desc;
  Info.prototype.get$websocket = function() {
    return this.websocket;
  };
  function InfoReceiverEvent(info, rtt, type) {
    this.info = info;
    this.rtt = rtt;
    this.type = type;
  }
  InfoReceiverEvent.builtin$cls = "InfoReceiverEvent";
  if (!"name" in InfoReceiverEvent)
    InfoReceiverEvent.name = "InfoReceiverEvent";
  $desc = $collectedClasses.InfoReceiverEvent;
  if ($desc instanceof Array)
    $desc = $desc[1];
  InfoReceiverEvent.prototype = $desc;
  InfoReceiverEvent.prototype.get$info = function() {
    return this.info;
  };
  function InfoReceiver() {
  }
  InfoReceiver.builtin$cls = "InfoReceiver";
  if (!"name" in InfoReceiver)
    InfoReceiver.name = "InfoReceiver";
  $desc = $collectedClasses.InfoReceiver;
  if ($desc instanceof Array)
    $desc = $desc[1];
  InfoReceiver.prototype = $desc;
  function Object_Emitter1() {
  }
  Object_Emitter1.builtin$cls = "Object_Emitter1";
  if (!"name" in Object_Emitter1)
    Object_Emitter1.name = "Object_Emitter1";
  $desc = $collectedClasses.Object_Emitter1;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Object_Emitter1.prototype = $desc;
  function AjaxInfoReceiver(events$Emitter$_evtController) {
    this.events$Emitter$_evtController = events$Emitter$_evtController;
  }
  AjaxInfoReceiver.builtin$cls = "AjaxInfoReceiver";
  if (!"name" in AjaxInfoReceiver)
    AjaxInfoReceiver.name = "AjaxInfoReceiver";
  $desc = $collectedClasses.AjaxInfoReceiver;
  if ($desc instanceof Array)
    $desc = $desc[1];
  AjaxInfoReceiver.prototype = $desc;
  function AjaxInfoReceiver_closure(this_0, baseUrl_1, xhrFactory_2) {
    this.this_0 = this_0;
    this.baseUrl_1 = baseUrl_1;
    this.xhrFactory_2 = xhrFactory_2;
  }
  AjaxInfoReceiver_closure.builtin$cls = "AjaxInfoReceiver_closure";
  if (!"name" in AjaxInfoReceiver_closure)
    AjaxInfoReceiver_closure.name = "AjaxInfoReceiver_closure";
  $desc = $collectedClasses.AjaxInfoReceiver_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  AjaxInfoReceiver_closure.prototype = $desc;
  function AjaxInfoReceiver_doXhr_closure(this_1) {
    this.this_1 = this_1;
  }
  AjaxInfoReceiver_doXhr_closure.builtin$cls = "AjaxInfoReceiver_doXhr_closure";
  if (!"name" in AjaxInfoReceiver_doXhr_closure)
    AjaxInfoReceiver_doXhr_closure.name = "AjaxInfoReceiver_doXhr_closure";
  $desc = $collectedClasses.AjaxInfoReceiver_doXhr_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  AjaxInfoReceiver_doXhr_closure.prototype = $desc;
  function AjaxInfoReceiver_doXhr_closure0(box_0, this_2, t0_3) {
    this.box_0 = box_0;
    this.this_2 = this_2;
    this.t0_3 = t0_3;
  }
  AjaxInfoReceiver_doXhr_closure0.builtin$cls = "AjaxInfoReceiver_doXhr_closure0";
  if (!"name" in AjaxInfoReceiver_doXhr_closure0)
    AjaxInfoReceiver_doXhr_closure0.name = "AjaxInfoReceiver_doXhr_closure0";
  $desc = $collectedClasses.AjaxInfoReceiver_doXhr_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  AjaxInfoReceiver_doXhr_closure0.prototype = $desc;
  function AjaxInfoReceiver_doXhr_closure1(this_4, xo_5) {
    this.this_4 = this_4;
    this.xo_5 = xo_5;
  }
  AjaxInfoReceiver_doXhr_closure1.builtin$cls = "AjaxInfoReceiver_doXhr_closure1";
  if (!"name" in AjaxInfoReceiver_doXhr_closure1)
    AjaxInfoReceiver_doXhr_closure1.name = "AjaxInfoReceiver_doXhr_closure1";
  $desc = $collectedClasses.AjaxInfoReceiver_doXhr_closure1;
  if ($desc instanceof Array)
    $desc = $desc[1];
  AjaxInfoReceiver_doXhr_closure1.prototype = $desc;
  function Polling(ri, receiverFactory, recvUrl, xhrFactory, poll, pollIsClosing) {
    this.ri = ri;
    this.receiverFactory = receiverFactory;
    this.recvUrl = recvUrl;
    this.xhrFactory = xhrFactory;
    this.poll = poll;
    this.pollIsClosing = pollIsClosing;
  }
  Polling.builtin$cls = "Polling";
  if (!"name" in Polling)
    Polling.name = "Polling";
  $desc = $collectedClasses.Polling;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Polling.prototype = $desc;
  function Polling__scheduleRecv_closure(box_0, this_1) {
    this.box_0 = box_0;
    this.this_1 = this_1;
  }
  Polling__scheduleRecv_closure.builtin$cls = "Polling__scheduleRecv_closure";
  if (!"name" in Polling__scheduleRecv_closure)
    Polling__scheduleRecv_closure.name = "Polling__scheduleRecv_closure";
  $desc = $collectedClasses.Polling__scheduleRecv_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Polling__scheduleRecv_closure.prototype = $desc;
  function Polling__scheduleRecv_closure0(box_0, this_2) {
    this.box_0 = box_0;
    this.this_2 = this_2;
  }
  Polling__scheduleRecv_closure0.builtin$cls = "Polling__scheduleRecv_closure0";
  if (!"name" in Polling__scheduleRecv_closure0)
    Polling__scheduleRecv_closure0.name = "Polling__scheduleRecv_closure0";
  $desc = $collectedClasses.Polling__scheduleRecv_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Polling__scheduleRecv_closure0.prototype = $desc;
  function XhrReceiver(xo, events$Emitter$_evtController) {
    this.xo = xo;
    this.events$Emitter$_evtController = events$Emitter$_evtController;
  }
  XhrReceiver.builtin$cls = "XhrReceiver";
  if (!"name" in XhrReceiver)
    XhrReceiver.name = "XhrReceiver";
  $desc = $collectedClasses.XhrReceiver;
  if ($desc instanceof Array)
    $desc = $desc[1];
  XhrReceiver.prototype = $desc;
  function XhrReceiver_closure(box_0, this_1) {
    this.box_0 = box_0;
    this.this_1 = this_1;
  }
  XhrReceiver_closure.builtin$cls = "XhrReceiver_closure";
  if (!"name" in XhrReceiver_closure)
    XhrReceiver_closure.name = "XhrReceiver_closure";
  $desc = $collectedClasses.XhrReceiver_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  XhrReceiver_closure.prototype = $desc;
  function XhrReceiver_closure0(this_2) {
    this.this_2 = this_2;
  }
  XhrReceiver_closure0.builtin$cls = "XhrReceiver_closure0";
  if (!"name" in XhrReceiver_closure0)
    XhrReceiver_closure0.name = "XhrReceiver_closure0";
  $desc = $collectedClasses.XhrReceiver_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  XhrReceiver_closure0.prototype = $desc;
  function Receiver() {
  }
  Receiver.builtin$cls = "Receiver";
  if (!"name" in Receiver)
    Receiver.name = "Receiver";
  $desc = $collectedClasses.Receiver;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Receiver.prototype = $desc;
  function Object_Emitter2() {
  }
  Object_Emitter2.builtin$cls = "Object_Emitter2";
  if (!"name" in Object_Emitter2)
    Object_Emitter2.name = "Object_Emitter2";
  $desc = $collectedClasses.Object_Emitter2;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Object_Emitter2.prototype = $desc;
  function BufferedSender() {
  }
  BufferedSender.builtin$cls = "BufferedSender";
  if (!"name" in BufferedSender)
    BufferedSender.name = "BufferedSender";
  $desc = $collectedClasses.BufferedSender;
  if ($desc instanceof Array)
    $desc = $desc[1];
  BufferedSender.prototype = $desc;
  function BufferedSender_sendScheduleWait_closure(box_0, this_1) {
    this.box_0 = box_0;
    this.this_1 = this_1;
  }
  BufferedSender_sendScheduleWait_closure.builtin$cls = "BufferedSender_sendScheduleWait_closure";
  if (!"name" in BufferedSender_sendScheduleWait_closure)
    BufferedSender_sendScheduleWait_closure.name = "BufferedSender_sendScheduleWait_closure";
  $desc = $collectedClasses.BufferedSender_sendScheduleWait_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  BufferedSender_sendScheduleWait_closure.prototype = $desc;
  function BufferedSender_sendScheduleWait_closure0(this_2) {
    this.this_2 = this_2;
  }
  BufferedSender_sendScheduleWait_closure0.builtin$cls = "BufferedSender_sendScheduleWait_closure0";
  if (!"name" in BufferedSender_sendScheduleWait_closure0)
    BufferedSender_sendScheduleWait_closure0.name = "BufferedSender_sendScheduleWait_closure0";
  $desc = $collectedClasses.BufferedSender_sendScheduleWait_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  BufferedSender_sendScheduleWait_closure0.prototype = $desc;
  function BufferedSender_sendSchedule_closure(this_0) {
    this.this_0 = this_0;
  }
  BufferedSender_sendSchedule_closure.builtin$cls = "BufferedSender_sendSchedule_closure";
  if (!"name" in BufferedSender_sendSchedule_closure)
    BufferedSender_sendSchedule_closure.name = "BufferedSender_sendSchedule_closure";
  $desc = $collectedClasses.BufferedSender_sendSchedule_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  BufferedSender_sendSchedule_closure.prototype = $desc;
  function createAjaxSender_closure(xhrFactory_0) {
    this.xhrFactory_0 = xhrFactory_0;
  }
  createAjaxSender_closure.builtin$cls = "createAjaxSender_closure";
  if (!"name" in createAjaxSender_closure)
    createAjaxSender_closure.name = "createAjaxSender_closure";
  $desc = $collectedClasses.createAjaxSender_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  createAjaxSender_closure.prototype = $desc;
  function createAjaxSender__closure(callback_1) {
    this.callback_1 = callback_1;
  }
  createAjaxSender__closure.builtin$cls = "createAjaxSender__closure";
  if (!"name" in createAjaxSender__closure)
    createAjaxSender__closure.name = "createAjaxSender__closure";
  $desc = $collectedClasses.createAjaxSender__closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  createAjaxSender__closure.prototype = $desc;
  function createAjaxSender__closure0(callback_2) {
    this.callback_2 = callback_2;
  }
  createAjaxSender__closure0.builtin$cls = "createAjaxSender__closure0";
  if (!"name" in createAjaxSender__closure0)
    createAjaxSender__closure0.name = "createAjaxSender__closure0";
  $desc = $collectedClasses.createAjaxSender__closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  createAjaxSender__closure0.prototype = $desc;
  function WebSocketTransport(ri, url, ws, messageSubscription, closeSubscription) {
    this.ri = ri;
    this.url = url;
    this.ws = ws;
  ...
  WebSocketTransport.builtin$cls = "WebSocketTransport";
  if (!"name" in WebSocketTransport)
    WebSocketTransport.name = "WebSocketTransport";
  $desc = $collectedClasses.WebSocketTransport;
  if ($desc instanceof Array)
    $desc = $desc[1];
  WebSocketTransport.prototype = $desc;
  function WebSocketTransport_enabled_closure(box_0) {
    this.box_0 = box_0;
  }
  WebSocketTransport_enabled_closure.builtin$cls = "WebSocketTransport_enabled_closure";
  if (!"name" in WebSocketTransport_enabled_closure)
    WebSocketTransport_enabled_closure.name = "WebSocketTransport_enabled_closure";
  $desc = $collectedClasses.WebSocketTransport_enabled_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  WebSocketTransport_enabled_closure.prototype = $desc;
  function AjaxBasedTransport() {
  }
  AjaxBasedTransport.builtin$cls = "AjaxBasedTransport";
  if (!"name" in AjaxBasedTransport)
    AjaxBasedTransport.name = "AjaxBasedTransport";
  $desc = $collectedClasses.AjaxBasedTransport;
  if ($desc instanceof Array)
    $desc = $desc[1];
  AjaxBasedTransport.prototype = $desc;
  function XhrStreamingTransport(ri, poll, sendBuffer, sender, sendStop, _sendStop, transUrl) {
    this.ri = ri;
    this.poll = poll;
    this.sendBuffer = sendBuffer;
    this.sender = sender;
    this.sendStop = sendStop;
    this._sendStop = _sendStop;
    this.transUrl = transUrl;
  }
  XhrStreamingTransport.builtin$cls = "XhrStreamingTransport";
  if (!"name" in XhrStreamingTransport)
    XhrStreamingTransport.name = "XhrStreamingTransport";
  $desc = $collectedClasses.XhrStreamingTransport;
  if ($desc instanceof Array)
    $desc = $desc[1];
  XhrStreamingTransport.prototype = $desc;
  function _ExactMatcher() {
  }
  _ExactMatcher.builtin$cls = "_ExactMatcher";
  if (!"name" in _ExactMatcher)
    _ExactMatcher.name = "_ExactMatcher";
  $desc = $collectedClasses._ExactMatcher;
  if ($desc instanceof Array)
    $desc = $desc[1];
  _ExactMatcher.prototype = $desc;
  function _StompClient(_connector, _parser, _session, _server, _onConnect, _onDisconnect, _stomp$_onError, _subscribers, _receipts, _connecting, _sendingBlob, _disconnected, heartbeat) {
    ...
    this._stomp$_onError = _stomp$_onError;
    this._subscribers = _subscribers;
    this._receipts = _receipts;
    this._connecting = _connecting;
    this._sendingBlob = _sendingBlob;
    this._disconnected = _disconnected;
    this.heartbeat = heartbeat;
  }
  _StompClient.builtin$cls = "_StompClient";
  if (!"name" in _StompClient)
    _StompClient.name = "_StompClient";
  $desc = $collectedClasses._StompClient;
  if ($desc instanceof Array)
    $desc = $desc[1];
  _StompClient.prototype = $desc;
  _StompClient.prototype.get$heartbeat = function() {
    return this.heartbeat;
  };
  function _StompClient__init_closure(this_0) {
    this.this_0 = this_0;
  }
  _StompClient__init_closure.builtin$cls = "_StompClient__init_closure";
  if (!"name" in _StompClient__init_closure)
    _StompClient__init_closure.name = "_StompClient__init_closure";
  $desc = $collectedClasses._StompClient__init_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  _StompClient__init_closure.prototype = $desc;
  function _StompClient__init_closure0(this_1) {
    this.this_1 = this_1;
  }
  _StompClient__init_closure0.builtin$cls = "_StompClient__init_closure0";
  if (!"name" in _StompClient__init_closure0)
    _StompClient__init_closure0.name = "_StompClient__init_closure0";
  $desc = $collectedClasses._StompClient__init_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  _StompClient__init_closure0.prototype = $desc;
  function _StompClient__init_closure1(this_2) {
    this.this_2 = this_2;
  }
  _StompClient__init_closure1.builtin$cls = "_StompClient__init_closure1";
  if (!"name" in _StompClient__init_closure1)
    _StompClient__init_closure1.name = "_StompClient__init_closure1";
  $desc = $collectedClasses._StompClient__init_closure1;
  if ($desc instanceof Array)
    $desc = $desc[1];
  _StompClient__init_closure1.prototype = $desc;
  function _StompClient__init_closure2(this_3) {
    this.this_3 = this_3;
  }
  _StompClient__init_closure2.builtin$cls = "_StompClient__init_closure2";
  if (!"name" in _StompClient__init_closure2)
    _StompClient__init_closure2.name = "_StompClient__init_closure2";
  $desc = $collectedClasses._StompClient__init_closure2;
  if ($desc instanceof Array)
    $desc = $desc[1];
  _StompClient__init_closure2.prototype = $desc;
  function _StompClient__init_closure3(this_4) {
    this.this_4 = this_4;
  }
  _StompClient__init_closure3.builtin$cls = "_StompClient__init_closure3";
  if (!"name" in _StompClient__init_closure3)
    _StompClient__init_closure3.name = "_StompClient__init_closure3";
  $desc = $collectedClasses._StompClient__init_closure3;
  if ($desc instanceof Array)
    $desc = $desc[1];
  _StompClient__init_closure3.prototype = $desc;
  function _StompClient__init_closure4(this_5) {
    this.this_5 = this_5;
  }
  _StompClient__init_closure4.builtin$cls = "_StompClient__init_closure4";
  if (!"name" in _StompClient__init_closure4)
    _StompClient__init_closure4.name = "_StompClient__init_closure4";
  $desc = $collectedClasses._StompClient__init_closure4;
  if ($desc instanceof Array)
    $desc = $desc[1];
  _StompClient__init_closure4.prototype = $desc;
  function _StompClient__message_closure(this_0) {
    this.this_0 = this_0;
  }
  _StompClient__message_closure.builtin$cls = "_StompClient__message_closure";
  if (!"name" in _StompClient__message_closure)
    _StompClient__message_closure.name = "_StompClient__message_closure";
  $desc = $collectedClasses._StompClient__message_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  _StompClient__message_closure.prototype = $desc;
  function closure() {
  }
  closure.builtin$cls = "closure";
  if (!"name" in closure)
  ...
  function _Subscriber(id, destination, matcher, type, onMessage, ack) {
    this.id = id;
  ...
  _Subscriber.builtin$cls = "_Subscriber";
  if (!"name" in _Subscriber)
    _Subscriber.name = "_Subscriber";
  $desc = $collectedClasses._Subscriber;
  if ($desc instanceof Array)
    $desc = $desc[1];
  _Subscriber.prototype = $desc;
  _Subscriber.prototype.get$type = function(receiver) {
    return this.type;
  };
  _Subscriber.prototype.get$onMessage = function(receiver) {
    return this.onMessage;
  };
  function _Subscriber_onFrame_closure(this_0, frame_1) {
    this.this_0 = this_0;
    this.frame_1 = frame_1;
  }
  _Subscriber_onFrame_closure.builtin$cls = "_Subscriber_onFrame_closure";
  if (!"name" in _Subscriber_onFrame_closure)
    _Subscriber_onFrame_closure.name = "_Subscriber_onFrame_closure";
  $desc = $collectedClasses._Subscriber_onFrame_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  _Subscriber_onFrame_closure.prototype = $desc;
  function Ack(id) {
    this.id = id;
  }
  Ack.builtin$cls = "Ack";
  if (!"name" in Ack)
    Ack.name = "Ack";
  $desc = $collectedClasses.Ack;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Ack.prototype = $desc;
  function StompClient() {
  }
  StompClient.builtin$cls = "StompClient";
  if (!"name" in StompClient)
    StompClient.name = "StompClient";
  $desc = $collectedClasses.StompClient;
  if ($desc instanceof Array)
    $desc = $desc[1];
  StompClient.prototype = $desc;
  function StompConnector(onBytes, onClose) {
    this.onBytes = onBytes;
    this.onClose = onClose;
  }
  StompConnector.builtin$cls = "StompConnector";
  if (!"name" in StompConnector)
    StompConnector.name = "StompConnector";
  $desc = $collectedClasses.StompConnector;
  if ($desc instanceof Array)
    $desc = $desc[1];
  StompConnector.prototype = $desc;
  StompConnector.prototype.set$onBytes = function(v) {
    return this.onBytes = v;
  };
  StompConnector.prototype.get$onClose = function(receiver) {
    return this.onClose;
  };
  function StringStompConnector() {
  }
  StringStompConnector.builtin$cls = "StringStompConnector";
  if (!"name" in StringStompConnector)
    StringStompConnector.name = "StringStompConnector";
  $desc = $collectedClasses.StringStompConnector;
  if ($desc instanceof Array)
    $desc = $desc[1];
  StringStompConnector.prototype = $desc;
  function StringStompConnector__flushAsync_closure(this_0) {
    this.this_0 = this_0;
  }
  StringStompConnector__flushAsync_closure.builtin$cls = "StringStompConnector__flushAsync_closure";
  if (!"name" in StringStompConnector__flushAsync_closure)
    StringStompConnector__flushAsync_closure.name = "StringStompConnector__flushAsync_closure";
  $desc = $collectedClasses.StringStompConnector__flushAsync_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  StringStompConnector__flushAsync_closure.prototype = $desc;
  function Frame(command, headers, string, bytes) {
  ...
  function FrameParser(_onFrame, _stomp_impl_util$_onError, _frame, _bodylen, _stomp_impl_util$_state, _bytebuf, _strbuf) {
    this._onFrame = _onFrame;
    this._stomp_impl_util$_onError = _stomp_impl_util$_onError;
    this._frame = _frame;
    this._bodylen = _bodylen;
    this._stomp_impl_util$_state = _stomp_impl_util$_state;
    this._bytebuf = _bytebuf;
    this._strbuf = _strbuf;
  }
  FrameParser.builtin$cls = "FrameParser";
  if (!"name" in FrameParser)
    FrameParser.name = "FrameParser";
  $desc = $collectedClasses.FrameParser;
  if ($desc instanceof Array)
    $desc = $desc[1];
  FrameParser.prototype = $desc;
  function connect_closure(host_0, login_1, passcode_2, heartbeat_3, onDisconnect_4, onError_5, onConnectionError_6) {
    this.host_0 = host_0;
    this.login_1 = login_1;
    this.passcode_2 = passcode_2;
    this.heartbeat_3 = heartbeat_3;
    this.onDisconnect_4 = onDisconnect_4;
    this.onError_5 = onError_5;
    this.onConnectionError_6 = onConnectionError_6;
  }
  connect_closure.builtin$cls = "connect_closure";
  if (!"name" in connect_closure)
    connect_closure.name = "connect_closure";
  $desc = $collectedClasses.connect_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  connect_closure.prototype = $desc;
  function connect__closure(onConnectionError_7) {
    this.onConnectionError_7 = onConnectionError_7;
  }
  connect__closure.builtin$cls = "connect__closure";
  if (!"name" in connect__closure)
    connect__closure.name = "connect__closure";
  $desc = $collectedClasses.connect__closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  connect__closure.prototype = $desc;
  function _SockDartConnector(_socket, _starting, _buf, onBytes, onString, onError, onClose) {
  ...
  _SockDartConnector.builtin$cls = "_SockDartConnector";
  if (!"name" in _SockDartConnector)
    _SockDartConnector.name = "_SockDartConnector";
  $desc = $collectedClasses._SockDartConnector;
  if ($desc instanceof Array)
    $desc = $desc[1];
  _SockDartConnector.prototype = $desc;
  function _SockDartConnector__init_closure(this_0) {
    this.this_0 = this_0;
  }
  _SockDartConnector__init_closure.builtin$cls = "_SockDartConnector__init_closure";
  if (!"name" in _SockDartConnector__init_closure)
    _SockDartConnector__init_closure.name = "_SockDartConnector__init_closure";
  $desc = $collectedClasses._SockDartConnector__init_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  _SockDartConnector__init_closure.prototype = $desc;
  function _SockDartConnector__init_closure0(this_1) {
    this.this_1 = this_1;
  }
  _SockDartConnector__init_closure0.builtin$cls = "_SockDartConnector__init_closure0";
  if (!"name" in _SockDartConnector__init_closure0)
    _SockDartConnector__init_closure0.name = "_SockDartConnector__init_closure0";
  $desc = $collectedClasses._SockDartConnector__init_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  _SockDartConnector__init_closure0.prototype = $desc;
  function _SockDartConnector__init_closure2(this_2) {
    this.this_2 = this_2;
  }
  _SockDartConnector__init_closure2.builtin$cls = "_SockDartConnector__init_closure2";
  if (!"name" in _SockDartConnector__init_closure2)
    _SockDartConnector__init_closure2.name = "_SockDartConnector__init_closure2";
  $desc = $collectedClasses._SockDartConnector__init_closure2;
  if ($desc instanceof Array)
    $desc = $desc[1];
  _SockDartConnector__init_closure2.prototype = $desc;
  function _SockDartConnector__init_closure1(this_3) {
    this.this_3 = this_3;
  }
  _SockDartConnector__init_closure1.builtin$cls = "_SockDartConnector__init_closure1";
  if (!"name" in _SockDartConnector__init_closure1)
    _SockDartConnector__init_closure1.name = "_SockDartConnector__init_closure1";
  $desc = $collectedClasses._SockDartConnector__init_closure1;
  if ($desc instanceof Array)
    $desc = $desc[1];
  _SockDartConnector__init_closure1.prototype = $desc;
  function _SockDartConnector__init_closure3(this_4) {
    this.this_4 = this_4;
  }
  _SockDartConnector__init_closure3.builtin$cls = "_SockDartConnector__init_closure3";
  if (!"name" in _SockDartConnector__init_closure3)
    _SockDartConnector__init_closure3.name = "_SockDartConnector__init_closure3";
  $desc = $collectedClasses._SockDartConnector__init_closure3;
  if ($desc instanceof Array)
    $desc = $desc[1];
  _SockDartConnector__init_closure3.prototype = $desc;
  function probeProtocols_closure(probed_0) {
    this.probed_0 = probed_0;
  }
  probeProtocols_closure.builtin$cls = "probeProtocols_closure";
  if (!"name" in probeProtocols_closure)
    probeProtocols_closure.name = "probeProtocols_closure";
  $desc = $collectedClasses.probeProtocols_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  probeProtocols_closure.prototype = $desc;
  function detectProtocols_closure(probed_1, pe_2) {
    this.probed_1 = probed_1;
    this.pe_2 = pe_2;
  }
  detectProtocols_closure.builtin$cls = "detectProtocols_closure";
  if (!"name" in detectProtocols_closure)
    detectProtocols_closure.name = "detectProtocols_closure";
  $desc = $collectedClasses.detectProtocols_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  detectProtocols_closure.prototype = $desc;
  function detectProtocols_closure0(box_0, pe_3, protocols_4) {
    this.box_0 = box_0;
    this.pe_3 = pe_3;
    this.protocols_4 = protocols_4;
  }
  detectProtocols_closure0.builtin$cls = "detectProtocols_closure0";
  if (!"name" in detectProtocols_closure0)
    detectProtocols_closure0.name = "detectProtocols_closure0";
  $desc = $collectedClasses.detectProtocols_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  detectProtocols_closure0.prototype = $desc;
  return [HtmlElement, AnchorElement, AnimationEvent, AreaElement, AudioElement, AutocompleteErrorEvent, BRElement, BaseElement, BeforeLoadEvent, BeforeUnloadEvent, Blob, BodyElement, ButtonElement, CDataSection, CanvasElement, CharacterData, CloseEvent0, Comment, CompositionEvent, ContentElement, CssFontFaceLoadEvent, CustomEvent, DListElement, DataListElement, DetailsElement, DeviceMotionEvent, DeviceOrientationEvent, DialogElement, DivElement, Document, DocumentFragment, DomError, DomException, DomImplementation, Element, EmbedElement, ErrorEvent, Event0, EventTarget, FieldSetElement, File, FileError, FocusEvent, FormElement, HRElement, HashChangeEvent, HeadElement, HeadingElement, HtmlDocument, HtmlHtmlElement, HttpRequest, HttpRequestEventTarget, IFrameElement, ImageElement, InputElement, InstallEvent, InstallPhaseEvent, KeyboardEvent, KeygenElement, LIElement, LabelElement, LegendElement, LinkElement, Location, MapElement, MediaElement, MediaError, MediaKeyError, MediaKeyEvent, MediaKeyMessageEvent, MediaKeyNeededEvent, MediaStream, MediaStreamEvent, MediaStreamTrackEvent, MenuElement, MessageEvent0, MetaElement, MeterElement, MidiConnectionEvent, MidiInput, MidiMessageEvent, MidiOutput, MidiPort, ModElement, MouseEvent, Navigator, NavigatorUserMediaError, Node, NodeList, OListElement, ObjectElement, OptGroupElement, OptionElement, OutputElement, OverflowEvent, PageTransitionEvent, ParagraphElement, ParamElement, PopStateEvent, PositionError, PreElement, ProcessingInstruction, ProgressElement, ProgressEvent, QuoteElement, Range, ResourceProgressEvent, RtcDataChannelEvent, RtcDtmfToneChangeEvent, RtcIceCandidateEvent, ScriptElement, SecurityPolicyViolationEvent, SelectElement, ShadowElement, ShadowRoot, SourceElement, SpanElement, SpeechInputEvent, SpeechRecognitionError, SpeechRecognitionEvent, SpeechSynthesisEvent, StorageEvent, StyleElement, TableCaptionElement, TableCellElement, TableColElement, TableElement, TableRowElement, TableSectionElement, TemplateElement, Text, TextAreaElement, TextEvent, TitleElement, TouchEvent, TrackElement, TrackEvent, TransitionEvent, UIEvent, UListElement, UnknownElement, VideoElement, WebSocket, WheelEvent, Window, XmlDocument, _Attr, _DocumentType, _HTMLAppletElement, _HTMLDirectoryElement, _HTMLFontElement, _HTMLFrameElement, _HTMLFrameSetElement, _HTMLMarqueeElement, _MutationEvent, _NamedNodeMap, _Notation, _XMLHttpRequestProgressEvent, VersionChangeEvent, AElement, AltGlyphElement, AnimateElement, AnimateMotionElement, AnimateTransformElement, AnimatedEnumeration, AnimatedNumberList, AnimatedString, AnimationElement, CircleElement, ClipPathElement, DefsElement, DescElement, DiscardElement, EllipseElement, FEBlendElement, FEColorMatrixElement, FEComponentTransferElement, FECompositeElement, FEConvolveMatrixElement, FEDiffuseLightingElement, FEDisplacementMapElement, FEDistantLightElement, FEFloodElement, FEFuncAElement, FEFuncBElement, FEFuncGElement, FEFuncRElement, FEGaussianBlurElement, FEImageElement, FEMergeElement, FEMergeNodeElement, FEMorphologyElement, FEOffsetElement, FEPointLightElement, FESpecularLightingElement, FESpotLightElement, FETileElement, FETurbulenceElement, FilterElement, ForeignObjectElement, GElement, GeometryElement, GraphicsElement, ImageElement0, LineElement, LinearGradientElement, MarkerElement, MaskElement, MetadataElement, PathElement, PatternElement, PolygonElement, PolylineElement, RadialGradientElement, RectElement, ScriptElement0, SetElement, StopElement, StyleElement0, SvgElement, SvgSvgElement, SwitchElement, SymbolElement, TSpanElement, TextContentElement, TextElement, TextPathElement, TextPositioningElement, TitleElement0, UseElement, ViewElement, ZoomEvent, _GradientElement, _SVGAltGlyphDefElement, _SVGAltGlyphItemElement, _SVGComponentTransferFunctionElement, _SVGCursorElement, _SVGFEDropShadowElement, _SVGFontElement, _SVGFontFaceElement, _SVGFontFaceFormatElement, _SVGFontFaceNameElement, _SVGFontFaceSrcElement, _SVGFontFaceUriElement, _SVGGlyphElement, _SVGGlyphRefElement, _SVGHKernElement, _SVGMPathElement, _SVGMissingGlyphElement, _SVGVKernElement, AudioProcessingEvent, OfflineAudioCompletionEvent, ContextEvent, SqlError, NativeByteBuffer, NativeTypedData, NativeByteData, NativeFloat32List, NativeFloat64List, NativeInt16List, NativeInt32List, NativeInt8List, NativeUint16List, NativeUint32List, NativeUint8ClampedList, NativeUint8List, JS_CONST, Interceptor, JSBool, JSNull, JavaScriptObject, PlainJavaScriptObject, UnknownJavaScriptObject, JSArray, JSNumber, JSInt, JSDouble, JSString, startRootIsolate_closure, startRootIsolate_closure0, _Manager, _IsolateContext, _IsolateContext_handlePing_respond, _EventLoop, _EventLoop__runHelper_next, _IsolateEvent, _MainManagerStub, IsolateNatives__processWorkerMessage_closure, IsolateNatives__processWorkerMessage_closure0, IsolateNatives__processWorkerMessage_closure1, IsolateNatives_spawn_closure, IsolateNatives_spawn_closure0, IsolateNatives__startNonWorker_closure, IsolateNatives__startIsolate_runStartFunction, _BaseSendPort, _NativeJsSendPort, _NativeJsSendPort_send_closure, _WorkerSendPort, RawReceivePortImpl, ReceivePortImpl, _JsSerializer, _JsCopier, _JsDeserializer, _JsVisitedMap, _MessageTraverserVisitedMap, _MessageTraverser, _Copier, _Copier_visitMap_closure, _Serializer, _Deserializer, TimerImpl, TimerImpl_internalCallback, TimerImpl_internalCallback0, CapabilityImpl, ReflectionInfo, TypeErrorDecoder, NullError, JsNoSuchMethodError, UnknownJsTypeError, unwrapException_saveStackTrace, _StackTrace, invokeClosure_closure, invokeClosure_closure0, invokeClosure_closure1, invokeClosure_closure2, invokeClosure_closure3, Closure, TearOffClosure, BoundClosure, RuntimeError, RuntimeType, RuntimeFunctionType, DynamicRuntimeType, TypeImpl, initHooks_closure, initHooks_closure0, initHooks_closure1, JSSyntaxRegExp, ListIterable, SubListIterable, ListIterator, MappedIterable, EfficientLengthMappedIterable, MappedIterator, MappedListIterable, WhereIterable, WhereIterator, FixedLengthListMixin, _AsyncRun__scheduleImmediateJsOverride_internalCallback, _AsyncError, _BroadcastStream, _BroadcastSubscription, _BroadcastStreamController, _SyncBroadcastStreamController, _SyncBroadcastStreamController__sendData_closure, _SyncBroadcastStreamController__sendError_closure, _SyncBroadcastStreamController__sendDone_closure, _AsyncBroadcastStreamController, Future, Future_Future_closure, _Completer, _AsyncCompleter, _Future, _Future__addListener_closure, _Future__chainForeignFuture_closure, _Future__chainForeignFuture_closure0, _Future__asyncComplete_closure, _Future__asyncComplete_closure0, _Future__asyncCompleteError_closure, _Future__propagateToListeners_handleValueCallback, _Future__propagateToListeners_handleError, _Future__propagateToListeners_handleWhenCompleteCallback, _Future__propagateToListeners_handleWhenCompleteCallback_closure, _Future__propagateToListeners_handleWhenCompleteCallback_closure0, _AsyncCallbackEntry, Stream, Stream_Stream$fromIterable_closure, Stream_forEach_closure, Stream_forEach__closure, Stream_forEach__closure0, Stream_forEach_closure0, Stream_length_closure, Stream_length_closure0, Stream_isEmpty_closure, Stream_isEmpty_closure0, Stream_first_closure, Stream_first_closure0, StreamSubscription, _StreamController, _StreamController__subscribe_closure, _StreamController__recordCancel_complete, _SyncStreamControllerDispatch, _AsyncStreamControllerDispatch, _AsyncStreamController, _StreamController__AsyncStreamControllerDispatch, _SyncStreamController, _StreamController__SyncStreamControllerDispatch, _ControllerStream, _ControllerSubscription, _EventSink, _BufferingStreamSubscription, _BufferingStreamSubscription__sendError_sendError, _BufferingStreamSubscription__sendDone_sendDone, _StreamImpl, _GeneratedStreamImpl, _IterablePendingEvents, _DelayedEvent, _DelayedData, _DelayedError, _DelayedDone, _PendingEvents, _PendingEvents_schedule_closure, _StreamImplEvents, _DoneStreamSubscription, _cancelAndError_closure, _cancelAndErrorClosure_closure, _cancelAndValue_closure, _ForwardingStream, _ForwardingStreamSubscription, _WhereStream, _MapStream, _BaseZone, _BaseZone_bindCallback_closure, _BaseZone_bindCallback_closure0, _BaseZone_bindUnaryCallback_closure, _BaseZone_bindUnaryCallback_closure0, _rootHandleUncaughtError_closure, _rootHandleUncaughtError__closure, _RootZone, _HashMap, _HashMap_values_closure, HashMapKeyIterable, HashMapKeyIterator, _LinkedHashMap, _LinkedHashMap_values_closure, _LinkedHashMap_addAll_closure, LinkedHashMapCell, LinkedHashMapKeyIterable, LinkedHashMapKeyIterator, _LinkedHashSet, LinkedHashSetCell, LinkedHashSetIterator, _HashSetBase, IterableBase, ListBase, Object_ListMixin, ListMixin, Maps_mapToString_closure, ListQueue, _ListQueueIterator, SetMixin, SetBase, _convertJsonToDart_closure, _convertJsonToDart_walk, Codec, Converter, Encoding, JsonUnsupportedObjectError, JsonCyclicError, JsonCodec, JsonEncoder, JsonDecoder, _JsonStringifier, Utf8Codec, Utf8Encoder, _Utf8Encoder, Utf8Decoder, _Utf8Decoder, _Utf8Decoder_convert_addSingleBytes, NoSuchMethodError_toString_closure, bool, DateTime, $double, Duration, Duration_toString_sixDigits, Duration_toString_twoDigits, Error, NullThrownError, ArgumentError, RangeError, UnsupportedError, UnimplementedError, StateError, ConcurrentModificationError, StackOverflowError, CyclicInitializationError, _ExceptionImplementation, FormatException, Expando, $int, Iterator, List, Null, num, Object, StackTrace, String, StringBuffer, Symbol, Element_Element$html_closure, _ChildNodeListLazy, Interceptor_ListMixin, Interceptor_ListMixin_ImmutableListMixin, Interceptor_ListMixin0, Interceptor_ListMixin_ImmutableListMixin0, _AttributeMap, _ElementAttributeMap, EventStreamProvider, _EventStream, _ElementEventStreamImpl, _ElementEventStreamImpl_matches_closure, _ElementEventStreamImpl_matches_closure0, _EventStreamSubscription, _Html5NodeValidator, ImmutableListMixin, NodeValidatorBuilder, NodeValidatorBuilder_allowsElement_closure, NodeValidatorBuilder_allowsAttribute_closure, _SimpleNodeValidator, _TemplatingNodeValidator, _TemplatingNodeValidator_closure, FixedSizeListIterator, _DOMWindowCrossFrame, NodeValidator, _SameOriginUriPolicy, _ValidatingTreeSanitizer, _ValidatingTreeSanitizer_sanitizeTree_walk, Capability, _JSRandom, UnmodifiableMapView, DelegatingMap_UnmodifiableMapMixin, UnmodifiableMapMixin, DelegatingMap, NativeTypedArray, NativeTypedArrayOfDouble, NativeTypedArray_ListMixin, NativeTypedArray_ListMixin_FixedLengthListMixin, NativeTypedArrayOfInt, NativeTypedArray_ListMixin0, NativeTypedArray_ListMixin_FixedLengthListMixin0, main_closure, main__closure, Event, Emitter, Emitter_operator$index_closure, convertNativeToDart_AcceptStructuredClone_findSlot, convertNativeToDart_AcceptStructuredClone_readSlot, convertNativeToDart_AcceptStructuredClone_writeSlot, convertNativeToDart_AcceptStructuredClone_walk, Logger, Logger_Logger_closure, Level, LogRecord, Protocol, StatusEvent, AbstractXHRObject, Object_Emitter, AbstractXHRObject__start_closure, XHRCorsObject, XHRCorsObject_closure, XHRLocalObject, XHRLocalObject_closure, CloseEvent, MessageEvent, Client, Object_Emitter0, Client_closure, Client__didClose_closure, Client__tryNextProtocol_closure, Client__tryNextProtocol_closure0, Info, InfoReceiverEvent, InfoReceiver, Object_Emitter1, AjaxInfoReceiver, AjaxInfoReceiver_closure, AjaxInfoReceiver_doXhr_closure, AjaxInfoReceiver_doXhr_closure0, AjaxInfoReceiver_doXhr_closure1, Polling, Polling__scheduleRecv_closure, Polling__scheduleRecv_closure0, XhrReceiver, XhrReceiver_closure, XhrReceiver_closure0, Receiver, Object_Emitter2, BufferedSender, BufferedSender_sendScheduleWait_closure, BufferedSender_sendScheduleWait_closure0, BufferedSender_sendSchedule_closure, createAjaxSender_closure, createAjaxSender__closure, createAjaxSender__closure0, WebSocketTransport, WebSocketTransport_enabled_closure, AjaxBasedTransport, XhrStreamingTransport, _ExactMatcher, _StompClient, _StompClient__init_closure, _StompClient__init_closure0, _StompClient__init_closure1, _StompClient__init_closure2, _StompClient__init_closure3, _StompClient__init_closure4, _StompClient__message_closure, closure, closure0, closure1, closure2, _Subscriber, _Subscriber_onFrame_closure, Ack, StompClient, StompConnector, StringStompConnector, StringStompConnector__flushAsync_closure, Frame, FrameParser, connect_closure, connect__closure, _SockDartConnector, _SockDartConnector__init_closure, _SockDartConnector__init_closure0, _SockDartConnector__init_closure2, _SockDartConnector__init_closure1, _SockDartConnector__init_closure3, probeProtocols_closure, detectProtocols_closure, detectProtocols_closure0];
}
